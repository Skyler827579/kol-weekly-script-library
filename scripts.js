...
function getArchivedMarketUpdates(lib) {
  ...
  return [
    ...
    buildMarketUpdate(lib.name, cfg, "mon-market", "历史稿件", "2026-06-13", "当日行情解读", "当天最新市场变化", JUNE_13_MARKET_READOUT_OVERRIDES, true),
    buildMarketUpdate(lib.name, cfg, "wed-market", "历史稿件", "2026-06-13", "当日行情跟进", "当天最新市场变化", JUNE_13_MARKET_READOUT_OVERRIDES, true),
    buildMarketUpdate(lib.name, cfg, "fri-market", "历史稿件", "2026-06-13", "当日行情复盘", "当天最新市场变化", JUNE_13_MARKET_READOUT_OVERRIDES, true),
    buildMarketUpdate(lib.name, cfg, "mon-market", "历史稿件", "2026-06-12", "当日行情解读", "当天最新市场变化", JUNE_12_MARKET_READOUT_OVERRIDES, true),
    buildMarketUpdate(lib.name, cfg, "wed-market", "历史稿件", "2026-06-12", "当日行情跟进", "当天最新市场变化", JUNE_12_MARKET_READOUT_OVERRIDES, true),
    buildMarketUpdate(lib.name, cfg, "fri-market", "历史稿件", "2026-06-12", "当日行情复盘", "当天最新市场变化", JUNE_12_MARKET_READOUT_OVERRIDES, true),
    buildMarketUpdate(lib.name, cfg, "mon-market", "历史稿件", "2026-06-11", "当日行情解读", "当天最新市场变化", JUNE_11_MARKET_READOUT_OVERRIDES, true),
    buildMarketUpdate(lib.name, cfg, "wed-market", "历史稿件", "2026-06-11", "当日行情跟进", "当天最新市场变化", JUNE_11_MARKET_READOUT_OVERRIDES, true),
    buildMarketUpdate(lib.name, cfg, "fri-market", "历史稿件", "2026-06-11", "当日行情复盘", "当天最新市场变化", JUNE_11_MARKET_READOUT_OVERRIDES, true),
    buildMarketUpdate(lib.name, cfg, "mon-market", "历史稿件", "2026-06-09", "当日行情解读", "当天最新市场变化", JUNE_9_MARKET_READOUT_OVERRIDES, true),
    buildMarketUpdate(lib.name, cfg, "wed-market", "历史稿件", "2026-06-09", "当日行情跟进", "当天最新市场变化", JUNE_9_MARKET_READOUT_OVERRIDES, true),
    buildMarketUpdate(lib.name, cfg, "fri-market", "历史稿件", "2026-06-09", "当日行情复盘", "当天最新市场变化", JUNE_9_MARKET_READOUT_OVERRIDES, true),
    buildMarketUpdate(lib.name, cfg, "mon-market", "历史稿件", "2026-06-08", "当日行情解读", "当天最新市场变化", JUNE_8_MARKET_READOUT_OVERRIDES, true),
    buildMarketUpdate(lib.name, cfg, "wed-market", "历史稿件", "2026-06-08", "当日行情跟进", "当天最新市场变化", JUNE_8_MARKET_READOUT_OVERRIDES, true),
    buildMarketUpdate(lib.name, cfg, "fri-market", "历史稿件", "2026-06-08", "当日行情复盘", "当天最新市场变化", JUNE_8_MARKET_READOUT_OVERRIDES, true),
...
const JUNE_15_MARKET_READOUT_OVERRIDES = {
  William: {
    "mon-market": {
      ...
      summary: "William 用 ICT/SMC 解读 2026-06-15：BTC、ETH、SOL 从周末薄流动性进入周一主交易时段，先看 6月14日高低点与周线开盘附近哪侧被扫，再等结构确认。",
      hook: "William 今天不要把周末方向直接外推到 Monday session。刷新行情后，先标出 6月14日高低点、周线开盘和亚洲盘边界，看 liquidity sweep 后有没有 displacement、CHOCH 和可守住的 retest。",
      outline: [
        "开场：把 6月15日定义成 weekend-to-Monday liquidity transition，先判断周末 move 能否被主交易时段接受。",
        "关键位：标出 6月14日高低点、周线开盘、亚洲盘高低点和最近 4H swing。",
        "结构：扫低后必须出现 displacement、CHOCH 与回踩守住；扫高后跌回周末区间按 buy-side liquidity grab 处理。",
        "动能：刷新后比较 BTC、ETH、SOL 的 RSI、MACD、ATR，确认结构反应是否同步且有足够空间。",
        "风险：Gold 周一重新交易但中期技术背景仍偏弱；只把实时 Gold 反应作为风险偏好交叉检查，不替代 crypto 结构。"
      ],
      talk: [
        "William 可以这样讲：on June 15, the first job is to see whether Monday accepts or rejects the liquidity created during the weekend.",
        "BTC 与 ETH 若同步扫低回收并形成 bullish CHOCH，再讲 discount retest；SOL 不参与或价格跌回 broken structure，就降低确定性。",
        "具体价格、RSI、MACD 和 ATR 全部由刷新行情写入口播，静态稿件只定义 liquidity、structure、confirmation 和 invalidation。"
      ],
      contextLines: [
        "The June 15 backdrop remains defensive after the prior week's crypto risk-off move, so Monday acceptance beyond the weekend range matters more than the first impulse.",
        "Gold enters the new week with a weak technical backdrop under higher-rate and firm-dollar pressure. Use its live reaction as cross-asset context, not as a fixed directional call."
      ],
      marketTemplate: "刷新后如果 BTC/ETH 扫过 6月14日低点或亚洲盘 sell-side 后快速回收，并形成 displacement、CHOCH 与 retest，主讲 FVG 或 order block 回踩；如果扫高失败、SOL 分化或 ATR 异常，主讲 Monday stop run 和等待。",
      assignment: "让成员提交 BTC 或 ETH 6月15日最新 4H 图，标出 6月14日高低点、周线开盘、亚洲盘区间、sweep、BOS/CHOCH、entry zone、SL 和第一目标。"
    },
    "wed-market": {
      title: "ICT 当日行情跟进：6月15日检验 Monday displacement",
      summary: "William 用 ICT/SMC 跟进 2026-06-15：检查 BTC、ETH、SOL 突破周末区间后是否留下可回踩结构，还是只在周一开盘完成 stop run。",
      hook: "William 今天只回答一个问题：Monday liquidity 被拿走以后，市场留下的是可交易的 displacement，还是没有 follow-through 的开盘假动作？",
      outline: [
        "开场：把当日跟进定义成 Monday structure quality check，不用第一根扩张 K 线判断趋势。",
        "流动性：观察 6月14日高低点、周线开盘与亚洲盘极值，确认 sweep 后价格最终被接受在哪一侧。",
        "结构：higher low、displacement、BOS/CHOCH 和回踩守住才讲延续；跌回 broken structure 就讲 failed acceptance。",
        "动能：刷新后用 BTC、ETH、SOL 的 RSI、MACD、ATR 检查 breadth、动能与剩余波动空间。",
        "风险：Gold 的实时方向若与 crypto 风险偏好冲突，缩小仓位；没有明确 invalidation 不参与。"
      ],
      talk: [
        "William 可以这样讲：Monday acceptance is real only when the structure shift survives a retest and more than one major coin confirms.",
        "BTC 与 ETH 同步守住、SOL 参与，才讲 continuation；单币拉升、扫高回落或没有 retest，只算 readout，不算 full-size entry。",
        "RSI、MACD 和 ATR 负责验证动能与空间，entry 仍来自 liquidity、structure 和 invalidation。"
      ],
      contextLines: [
        "June 15 should separate durable Monday acceptance beyond the weekend range from a temporary opening-session stop run in a still-defensive crypto market.",
        "Cross-crypto breadth and gold's live reopening response are confirmation inputs; neither replaces a clear structure shift and retest."
      ],
      marketTemplate: "刷新后如果 BTC/ETH 在 6月14日区间或亚洲盘边缘扫单回收、形成 higher low 且 SOL 同步，主讲 CHOCH 后回踩；如果扫高失败、ATR 异常或跌回 broken structure，主讲 Monday fake acceptance 和继续等待。",
      assignment: "让成员提交 BTC 或 ETH 6月15日最新 4H 图，标出周末区间、周线开盘、亚洲盘极值、sweep、displacement、BOS/CHOCH、retest、SL 和第一目标。"
    },
    "fri-market": {
      title: "ICT 当日复盘转化：6月15日只保留完整 Monday sequence",
      summary: "William 用 2026-06-15 当日复盘筛选周一有效结构，只保留 liquidity、acceptance、structure shift、retest 和 invalidation 完整的计划。",
      hook: "William 今天不复盘谁猜对 Monday direction，只复盘 6月15日有没有把 weekend liquidity 转成完整、可验证的 ICT sequence。",
      outline: [
        "开场：复盘市场对 6月14日区间、周线开盘和亚洲盘极值的接受或拒绝。",
        "流动性：回看周末高低点与周一 session 边界中最清楚的一次 sweep。",
        "结构：把 acceptance、BOS/CHOCH、FVG 或 order block 回踩和 invalidation 画完整。",
        "动能：刷新后用 BTC/ETH 的 RSI、MACD、ATR，并参考 SOL 与 Gold 是否同步验证结论。",
        "风险：防守型市场里只奖励完整 sequence；ATR 扩张缩小仓位，缺少结构就记录 no trade。"
      ],
      talk: [
        "William 可以这样讲：the lesson is whether Monday price action earned acceptance beyond the weekend range.",
        "只有 sweep、displacement、CHOCH 和 retest 都出现，才是 ICT setup；快速扩张、单币领先或没有 invalidation 都不是 entry。",
        "Gold 若继续承压而 crypto breadth 也弱，优先保护资本；跨资产出现改善也必须等结构确认。"
      ],
      contextLines: [
        "Use this as the June 15 same-day review of whether active-session liquidity confirmed or rejected the weekend move.",
        "Reward confirmed structure and broad participation, not prediction, candle size, or a fixed market-price narrative."
      ],
      marketTemplate: "刷新后如果 BTC/ETH 已给出 sweep + acceptance + displacement + CHOCH + retest，主讲确认后的计划；如果扫高回落、SOL 不同步或动能衰减，主讲为什么 Monday 没有 entry。",
      assignment: "让成员提交一张 6月15日复盘图，标出周末区间、周线开盘、session 高低点、sweep、acceptance、BOS/CHOCH、回踩区、SL 和第一目标。"
    }
  },
  KC: {
    "mon-market": {
      title: "20 EMA 当日行情解读：6月15日让 Monday move 先通过 Blueprint",
      summary: "KC 用 20 EMA Blueprint 解读 2026-06-15：BTC、ETH、SOL 先检查相对 20 EMA 的位置、周一动能和 ATR，Gold 用实时开盘反应补充风险背景。",
      hook: "KC 今天不要把 weekend move 自动当成 Monday continuation。刷新行情后先回答：is price holding the 20 EMA, reclaiming it, or only bouncing into resistance?",
      outline: [
        "开场：把 6月15日定义成 Monday Blueprint check，不追离均线太远的开盘扩张。",
        "位置：标出主图 20 EMA、6月14日高低点、周线开盘和周一第一次回踩。",
        "确认：价格在 EMA 正确一侧并得到实时 RSI、MACD 配合，才算 clean hold、reclaim 或 continuation。",
        "目标：用实时 ATR 约束 TP；BTC、ETH、SOL 若分化，主动缩小仓位和目标。",
        "风险：Gold 技术背景偏弱，周一实时开盘若继续受收益率与美元压力，只作为风险过滤器，不替代 Blueprint。"
      ],
      talk: [
        "KC 可以这样讲：on Monday, the Blueprint still starts with location. No clean EMA hold or reclaim means no clean setup.",
        "价格守住 20 EMA、RSI 守中线且 MACD 改善，才讲 first pullback；碰到 EMA 后再次被拒绝就把它当 resistance。",
        "具体报价与指标由刷新后的页面提供，静态稿件只定义位置、确认、止损和 ATR-based target。"
      ],
      contextLines: [
        "The June 15 setup is a Monday location check after crypto entered the week with a defensive backdrop and a weekend range awaiting active-session confirmation.",
        "Gold remains technically vulnerable under higher-rate and firm-dollar pressure. Its live reopening response is a filter, while EMA location, breadth, momentum, and ATR drive the trade."
      ],
      marketTemplate: "刷新后如果主图守住或重新 reclaim 20 EMA，RSI/MACD 配合且第一次周一回踩稳定，主讲 Monday continuation；如果失去 EMA、跨币分化或 ATR 不支持目标，主讲 failed reclaim。",
      assignment: "让成员提交 BTC、Gold 或 SOL 6月15日最新图，标出 20 EMA、6月14日高低点、周线开盘、周一第一次回踩、entry、SL 和实时 ATR 目标。"
    },
    "wed-market": {
      title: "20 EMA 当日行情跟进：6月15日守线才算周一确认",
      summary: "KC 用 20 EMA Blueprint 跟进 2026-06-15：周一第一次回踩是否守线、RSI/MACD 是否确认、ATR 是否支持目标，决定参与还是等待。",
      hook: "KC 今天的 quality check 很简单：did the EMA hold after the weekend range was tested? 守不住均线，就没有 clean Monday continuation setup。",
      outline: [
        "开场：把跟进定义成 Monday first-pullback check，避免追已经离开均线的位置。",
        "位置：检查主图是否贴近 20 EMA，以及周一回踩是否守在均线正确一侧。",
        "确认：刷新后用 RSI 中线和 MACD 柱体判断是真修复、趋势延续还是开盘回抽。",
        "目标：用实时 ATR 制定第一目标；跨币分化、波动过小或异常扩大时降低仓位。",
        "风险：Gold 实时反应若继续偏弱，要求 crypto 给出更干净的 EMA hold 与 breadth。"
      ],
      talk: [
        "KC 可以这样讲：Monday confirmation means the EMA hold survives the first pullback after the weekend range is tested.",
        "BTC 在 EMA 上方但 ETH 或 SOL 不确认，可以有 readout，但不一定有 full-size trade。",
        "价格碰到 EMA 后立即被拒绝，this is resistance, not a late Monday long entry."
      ],
      contextLines: [
        "The June 15 follow-up tests whether the opening move can hold through a first pullback while the broader crypto backdrop remains defensive.",
        "Live 20 EMA location, cross-crypto participation, RSI, MACD, ATR, and gold's reopening tone carry more weight than the weekend candle."
      ],
      marketTemplate: "刷新后如果主图在 20 EMA 上方完成第一次周一回踩、RSI 守中线且 MACD 改善，主讲 continuation；如果跌回 EMA 下方、ATR 异常或跨币分化，主讲 fake reclaim 和等待。",
      assignment: "让成员提交 BTC、Gold 或 SOL 6月15日最新图，标出 20 EMA、周末区间、周线开盘、第一次周一回踩、entry zone、SL 和实时 ATR 第一目标。"
    },
    "fri-market": {
      title: "20 EMA 当日复盘转化：6月15日让 ATR 过滤开盘噪音",
      summary: "KC 用 2026-06-15 当日复盘判断 Monday move 是否符合 Blueprint：20 EMA 定位置，RSI/MACD 定质量，ATR 定现实目标。",
      hook: "KC 今天复盘不要比较谁抓到 Monday move。Show me whether the EMA held, momentum confirmed, and ATR justified the target。",
      outline: [
        "开场：复盘周末区间被测试后，周一 move 有没有尊重 20 EMA。",
        "位置：标出主图、20 EMA、周末高低点、周线开盘和第一次周一回踩的关系。",
        "确认：刷新后用 RSI、MACD 判断延续、拒绝还是低动能震荡。",
        "目标：用实时 ATR 检查 TP 是否现实，开盘波动异常扩大时先缩小仓位。",
        "转化：要求成员提交 entry、SL、TP，并写明为何持有、减仓或不参与。"
      ],
      talk: [
        "KC 可以这样讲：a weak Monday move fails when price cannot hold the EMA and momentum fades.",
        "守住 EMA 后的第一次回踩，复盘 clean continuation；跌回 EMA 下方，复盘为什么没有 entry。",
        "跨币分化、Gold 的弱技术背景和 ATR 变化都要求先执行纪律，再讨论方向。"
      ],
      contextLines: [
        "Use this as a June 15 Blueprint recap of live Monday markets against the weekend range and weekly open.",
        "Every conclusion should map to EMA location, momentum quality, ATR-based target, and a predefined risk decision."
      ],
      marketTemplate: "刷新后如果主图在 20 EMA 上方且 RSI 守中线，主讲守线后的第一次回踩；如果价格低于 EMA、MACD 走弱、ATR 异常或跨币不确认，主讲短目标、离场或观望。",
      assignment: "让成员提交一张 6月15日复盘图，标出 20 EMA、周末区间、周线开盘、entry zone、SL、第一目标和实时 ATR 依据。"
    }
  },
  Caven: {
    "mon-market": {
      title: "Scalp 当日行情解读：6月15日只做 Monday 边界反应",
      summary: "Caven 用 liquidity、VWAP 和 ATR 解读 2026-06-15：BTC/SOL 只交易 6月14日或周一 session 边界 sweep 后的 VWAP 回收与拒绝。",
      hook: "Caven 今天不要在 Monday range 中间追。先刷新行情，把 SOL/BTC 的 6月14日 high/low、周线开盘、亚洲盘边界和 VWAP 画出来。",
      outline: [
        "开场：说明 6月15日是 Monday scalp day，重点是边界反应，不是延伸周末方向。",
        "流动性：标出 SOL/BTC 的 6月14日高低点、周线开盘、亚洲盘 high/low 和最近清算区。",
        "VWAP：扫低并回收 VWAP 才讲 long scalp；扫高后跌回 VWAP 下方才讲 short scalp。",
        "波动：刷新后读取 RSI、MACD、ATR，并用 BTC、ETH、SOL 是否同步检查参与度。",
        "风险：区间中间、低 ATR 或失控扩张环境都不追单；Gold 周一实时反应只作为风险过滤。"
      ],
      talk: [
        "Caven 可以这样讲：Monday volatility is not an entry. We trade the reaction at the weekend high, low, weekly open, or a fresh session edge.",
        "SOL 扫 session low、收回关键边界并站上 VWAP，而且 BTC 同步，才有 quick long scalp；扫高失去 VWAP 就讲 trap breakout。",
        "静态稿件不写死价格，最近 key levels 都来自刷新后的图表、6月14日区间与当日 session。"
      ],
      contextLines: [
        "The June 15 scalp backdrop is an active-session return after a defensive crypto week and a weekend range that still needs confirmation.",
        "Gold's weak technical backdrop is risk context only. Scalp triggers still come from boundary liquidity, VWAP, participation, ATR, and fast invalidation."
      ],
      marketTemplate: "刷新后如果 SOL/BTC 扫低、收回 6月14日或周一 session 边界并站上 VWAP，且实时 ATR 足够，主讲 quick long scalp；如果扫高失败、低于 VWAP 或卡在中间，主讲 short scalp 或等待。",
      assignment: "让成员提交 SOL 或 BTC 6月15日 15M 图，标出 6月14日 high/low、周线开盘、周一 session 边界、一次 sweep、VWAP、entry、SL 和第一止盈。"
    },
    "wed-market": {
      title: "Scalp 当日行情跟进：6月15日检查 Monday VWAP reaction",
      summary: "Caven 用 liquidity、VWAP 和短线波动跟进 2026-06-15：只看周末或周一边界被扫后的回收与拒绝，并用 ATR 判断是否还有 scalp 空间。",
      hook: "Caven 今天跟进先问三个问题：周一边界 sweep 了吗，VWAP 守住了吗，ATR 还可控吗？少一个就等。",
      outline: [
        "开场：把跟进定义成 Monday reaction check，不追已经发生的第一段开盘扩张。",
        "流动性：确认 SOL/BTC 哪一侧周末或周一 session liquidity 已被扫，哪一侧仍是下一目标。",
        "VWAP：扫低后回收并守住才讲 continuation；扫高后跌回下方就讲 trap breakout。",
        "波动：刷新后用 RSI、MACD、ATR 检查动能、空间与跨币同步。",
        "执行：区间中间、ATR 失控、VWAP 反复穿越都不是 clean scalp，失败要快速退出。"
      ],
      talk: [
        "Caven 可以这样讲：the reaction at the Monday edge matters more than the size of the first candle.",
        "SOL 扫低后站回 VWAP、RSI 修复且 BTC 同步，可以讲 quick long scalp。",
        "价格回到 VWAP 又马上失守，shorten the target, close quickly, or skip the trade."
      ],
      contextLines: [
        "The June 15 follow-up focuses on whether price can hold VWAP after liquidity is taken at the weekend range or a fresh Monday session edge.",
        "Live ATR and cross-crypto participation decide whether the move has enough controlled range for a scalp."
      ],
      marketTemplate: "刷新后如果 SOL/BTC 在边界 sweep 后守住 VWAP、且 ATR 仍支持空间，主讲 Monday scalp；如果价格低于 VWAP、ATR 失控或 RSI 没修复，主讲 failed retest 和等待。",
      assignment: "让成员提交 SOL 或 BTC 6月15日 15M 图，标出周末与周一 session 边界、sweep、VWAP 回收或拒绝、entry、SL 和第一止盈。"
    },
    "fri-market": {
      title: "Scalp 当日复盘转化：6月15日只复盘 edge、sweep、VWAP",
      summary: "Caven 用 2026-06-15 当日复盘把周末区间、周一 session sweep、VWAP、RSI 和 ATR 转成短线作业，中间位置不点评。",
      hook: "Caven 今天不复盘谁抓到周一方向，只复盘有没有 edge、sweep、VWAP reaction 和可控 ATR。",
      outline: [
        "开场：复盘周一最清楚的一次扫高或扫低，不用固定价格总结。",
        "流动性：标出 SOL/BTC 的 6月14日高低点、周线开盘、周一 session 边界和被扫的一侧。",
        "VWAP：确认 sweep 后是回收、拒绝，还是一直在中间震荡。",
        "波动：刷新后用 RSI、MACD、ATR 判断这笔 scalp 是否有足够且可控的空间。",
        "转化：止损必须放在 sweep 外侧，VWAP 失效就快速退出，不把 Monday scalp 变成长仓。"
      ],
      talk: [
        "Caven 可以这样讲：the clean trade is the reaction after Monday liquidity is taken and VWAP confirms.",
        "SOL 或 BTC 扫 session low 后站回 VWAP，并且 RSI 修复，复盘 clean long scalp；扫高后跌回 VWAP 下方就复盘 trap breakout。",
        "ATR 收缩时目标变小，ATR 失控时仓位变小，不留没有明确止损的方向仓位。"
      ],
      contextLines: [
        "Use this as the June 15 same-day scalp review against the weekend range and weekly open.",
        "Every recap should map to the Monday boundary, sweep, VWAP reaction, momentum, ATR space, and a clear exit decision."
      ],
      marketTemplate: "刷新后如果 SOL/BTC 的 ATR 仍支持可控空间且 RSI 修复，主讲扫低回收 VWAP；如果 ATR 失控、价格低于 VWAP 或卡在 session 中间，主讲缩小仓位、扫高失败或等待。",
      assignment: "让成员提交一张 6月15日 15M 复盘图，标出 6月14日 high/low、周线开盘、周一 session 边界、一次有效 sweep、VWAP、entry、SL 和第一止盈。"
    }
  }
};

const JUNE_14_MARKET_READOUT_OVERRIDES = {
  William: {
    "mon-market": {
      title: "ICT 当日行情解读：6月14日先读周末区间第二天的流动性",
      summary: "William 用 ICT/SMC 解读 2026-06-14：BTC、ETH、SOL 在本周风险资产回落后的第二个周末交易日，先看 6月13日区间和周线收盘附近哪侧流动性被拿走。",
      hook: "William 今天不要把周日的小幅波动当成新趋势。刷新行情后，先标出 6月13日高低点、周线收盘和当前周末区间，看 sweep 后有没有 displacement、CHOCH 和可守住的 retest。",
      outline: [
        "开场：把 6月14日定义成 weekend day-two liquidity test，先确认市场在 6月13日区间哪一侧获得 acceptance。",
        "关键位：标出 6月13日高低点、6月12日周线收盘、本周高低点和当前 session 边界。",
        "结构：扫低后必须出现 displacement、CHOCH 与回踩守住；扫高后跌回区间按 buy-side liquidity grab 处理。",
        "动能：刷新后比较 BTC、ETH、SOL 的 RSI、MACD、ATR，判断结构反应是否有跨币同步和足够空间。",
        "风险：Gold 周日闭市，只把本周在强美元、高收益率压力下的弱势作为宏观背景；周末仓位更小，invalidation 必须先画。"
      ],
      talk: [
        "William 可以这样讲：on June 14, Sunday direction matters less than whether liquidity taken from Saturday's range creates real structure.",
        "BTC 与 ETH 若同步扫低回收并形成 bullish CHOCH，再讲 discount retest；SOL 不参与或价格跌回 broken structure，就降低确定性。",
        "价格、RSI、MACD 和 ATR 全部由刷新行情写入口播，静态稿件只定义 liquidity、structure、confirmation 和 risk sequence。"
      ],
      contextLines: [
        "The June 14 backdrop remains defensive after crypto sold off earlier in the week, while Sunday liquidity can exaggerate moves around Saturday's range and the weekly close.",
        "Gold finished the week under pressure as higher yields and a firm dollar reduced safe-haven support. Because gold is closed on Sunday, treat that as macro context rather than a live trigger."
      ],
      marketTemplate: "刷新后如果 BTC/ETH 扫过 6月13日低点或周末 sell-side 后快速回收，并形成 displacement、CHOCH 与 retest，主讲 FVG 或 order block 回踩；如果扫高失败、SOL 分化或 ATR 异常，主讲周日薄流动性 stop run 和等待。",
      assignment: "让成员提交 BTC 或 ETH 6月14日最新 4H 图，标出 6月13日高低点、周线收盘、周末区间、sweep、BOS/CHOCH、entry zone、SL 和第一目标。"
    },
    "wed-market": {
      title: "ICT 当日行情跟进：6月14日检验周末结构能否延续",
      summary: "William 用 ICT/SMC 跟进 2026-06-14：检查 BTC、ETH、SOL 对 6月13日区间的突破是有效 acceptance，还是周日低流动性环境中的 stop run。",
      hook: "William 今天只回答一个问题：6月13日 liquidity 被拿走以后，市场留下的是可回踩结构，还是没有 follow-through 的周末假动作？",
      outline: [
        "开场：把当日跟进定义成 weekend structure quality check，不用单根周日 K 线判断趋势。",
        "流动性：观察 6月13日高低点、周线收盘和周末极值，确认 sweep 后价格最终被接受在哪一侧。",
        "结构：higher low、displacement、BOS/CHOCH 和回踩守住才讲延续；跌回 broken structure 就讲 failed acceptance。",
        "动能：刷新后用 BTC、ETH、SOL 的 RSI、MACD、ATR 检查 breadth、动能与剩余波动空间。",
        "风险：Gold 保留最后交易时段数据但周日不更新；crypto 若缺少同步性与明确 invalidation，不扩大仓位。"
      ],
      talk: [
        "William 可以这样讲：weekend acceptance is real only when the structure shift survives a retest and more than one major coin confirms.",
        "BTC 与 ETH 同步守住、SOL 参与，才讲 continuation；单币拉升、扫高回落或没有 retest，只算 readout，不算 full-size entry。",
        "RSI、MACD 和 ATR 负责验证动能与空间，entry 仍来自 liquidity、structure 和 invalidation。"
      ],
      contextLines: [
        "June 14 should separate durable acceptance beyond Saturday's range from a temporary Sunday stop run in a still-defensive crypto market.",
        "Cross-crypto breadth is the live confirmation. Gold's weak weekly context cannot replace a real-time crypto structure signal while that market is closed."
      ],
      marketTemplate: "刷新后如果 BTC/ETH 在 6月13日区间边缘扫单回收、形成 higher low 且 SOL 同步，主讲 CHOCH 后回踩；如果扫高失败、ATR 异常或跌回 broken structure，主讲周日假 acceptance 和继续等待。",
      assignment: "让成员提交 BTC 或 ETH 6月14日最新 4H 图，标出 6月13日区间、周线收盘、周末极值、sweep、displacement、BOS/CHOCH、retest、SL 和第一目标。"
    },
    "fri-market": {
      title: "ICT 当日复盘转化：6月14日只保留完整周末 sequence",
      summary: "William 用 2026-06-14 当日复盘筛选周末第二天的有效结构，只保留 liquidity、acceptance、structure shift、retest 和 invalidation 完整的计划。",
      hook: "William 今天不复盘谁猜对周日方向，只复盘 6月14日有没有把 Saturday range liquidity 转成完整、可验证的 ICT sequence。",
      outline: [
        "开场：复盘市场对 6月13日区间、周线收盘和周末极值的接受或拒绝。",
        "流动性：回看周六高低点与周日 session 边界中最清楚的一次 sweep。",
        "结构：把 acceptance、BOS/CHOCH、FVG 或 order block 回踩和 invalidation 画完整。",
        "动能：刷新后用 BTC/ETH 的 RSI、MACD、ATR，并参考 SOL 是否同步验证结论。",
        "风险：Gold 周日闭市且本周偏弱，只保留宏观背景；不为不完整 sequence 留高杠杆隔夜仓位。"
      ],
      talk: [
        "William 可以这样讲：the lesson is whether Sunday price action earned acceptance beyond Saturday's range.",
        "只有 sweep、displacement、CHOCH 和 retest 都出现，才是 ICT setup；快速扩张、单币领先或没有 invalidation 都不是 entry。",
        "ATR 扩张时缩小仓位，ATR 收缩时缩小目标，没有完整结构就记录 no trade。"
      ],
      contextLines: [
        "Use this as the June 14 same-day review of whether weekend crypto confirmed or rejected the move around Saturday's range and the weekly close.",
        "Reward confirmed structure and broad participation, not prediction, candle size, or a stale gold quote while that market is closed."
      ],
      marketTemplate: "刷新后如果 BTC/ETH 已给出 sweep + acceptance + displacement + CHOCH + retest，主讲确认后的计划；如果扫高回落、SOL 不同步或动能衰减，主讲为什么周日没有 entry。",
      assignment: "让成员提交一张 6月14日复盘图，标出 6月13日区间、周线收盘、周末高低点、sweep、acceptance、BOS/CHOCH、回踩区、SL 和第一目标。"
    }
  },
  KC: {
    "mon-market": {
      title: "20 EMA 当日行情解读：6月14日让周日行情先通过 Blueprint",
      summary: "KC 用 20 EMA Blueprint 解读 2026-06-14：BTC、ETH、SOL 先检查相对 20 EMA 的位置、周末动能和 ATR，Gold 只采用最后交易时段及弱周线作为风险背景。",
      hook: "KC 今天不要把 Saturday move 自动当成 Sunday continuation。刷新行情后先回答：is price holding the 20 EMA, reclaiming it, or only bouncing into resistance?",
      outline: [
        "开场：把 6月14日定义成 Sunday Blueprint check，不追离均线太远的薄流动性扩张。",
        "位置：标出主图 20 EMA、6月13日高低点、周线收盘和周日第一次回踩。",
        "确认：价格在 EMA 正确一侧并得到实时 RSI、MACD 配合，才算 clean hold、reclaim 或 continuation。",
        "目标：用实时 ATR 约束 TP；BTC、ETH、SOL 若分化，主动缩小仓位和目标。",
        "风险：Gold 周日闭市，本周在高收益率与强美元背景下偏弱；没有 crypto Blueprint 确认就继续等。"
      ],
      talk: [
        "KC 可以这样讲：on Sunday, the Blueprint still starts with location. No clean EMA hold or reclaim means no clean setup.",
        "价格守住 20 EMA、RSI 守中线且 MACD 改善，才讲 first pullback；碰到 EMA 后再次被拒绝就把它当 resistance。",
        "具体报价与指标由刷新后的页面提供，静态稿件只定义位置、确认、止损和 ATR-based target。"
      ],
      contextLines: [
        "The June 14 setup is a Sunday location check after crypto remained under broader pressure earlier in the week and weekend liquidity stayed thinner.",
        "Gold's weak weekly finish under higher yields and a firm dollar is context only. Live crypto EMA location, breadth, momentum, and ATR must drive the setup."
      ],
      marketTemplate: "刷新后如果主图守住或重新 reclaim 20 EMA，RSI/MACD 配合且第一次回踩稳定，主讲 Sunday continuation；如果失去 EMA、跨币分化或 ATR 不支持目标，主讲 thin-liquidity failed reclaim。",
      assignment: "让成员提交 BTC、Gold 或 SOL 6月14日最新图，标出 20 EMA、6月13日高低点、周线收盘、周日第一次回踩、entry、SL 和实时 ATR 目标。"
    },
    "wed-market": {
      title: "20 EMA 当日行情跟进：6月14日守线才算周日确认",
      summary: "KC 用 20 EMA Blueprint 跟进 2026-06-14：周日第一次回踩是否守线、RSI/MACD 是否确认、ATR 是否支持目标，决定参与还是等待。",
      hook: "KC 今天的 quality check 很简单：did the EMA hold after Saturday's range was tested? 守不住均线，就没有 clean Sunday continuation setup。",
      outline: [
        "开场：把跟进定义成 Sunday first-pullback check，避免追已经离开均线的位置。",
        "位置：检查主图是否贴近 20 EMA，以及周日回踩是否守在均线正确一侧。",
        "确认：刷新后用 RSI 中线和 MACD 柱体判断是真修复、趋势延续还是低流动性回抽。",
        "目标：用实时 ATR 制定第一目标；跨币分化、波动过小或异常扩大时降低仓位。",
        "风险：Gold 的最后交易时段只代表宏观环境，周日不能替代 crypto Blueprint 的实时确认。"
      ],
      talk: [
        "KC 可以这样讲：Sunday confirmation means the EMA hold survives the first pullback after Saturday's range is tested.",
        "BTC 在 EMA 上方但 ETH 或 SOL 不确认，可以有 readout，但不一定有 full-size trade。",
        "价格碰到 EMA 后立即被拒绝，this is resistance, not a late Sunday long entry."
      ],
      contextLines: [
        "The June 14 follow-up tests whether the weekend move can hold through a first pullback while the broader crypto backdrop remains defensive.",
        "Live 20 EMA location, cross-crypto participation, RSI, MACD, and ATR carry more weight than Saturday's candle or gold's unchanged Sunday quote."
      ],
      marketTemplate: "刷新后如果主图在 20 EMA 上方完成第一次周日回踩、RSI 守中线且 MACD 改善，主讲 continuation；如果跌回 EMA 下方、ATR 异常或跨币分化，主讲 fake reclaim 和等待。",
      assignment: "让成员提交 BTC、Gold 或 SOL 6月14日最新图，标出 20 EMA、6月13日区间、周线收盘、第一次周日回踩、entry zone、SL 和实时 ATR 第一目标。"
    },
    "fri-market": {
      title: "20 EMA 当日复盘转化：6月14日让 ATR 过滤周日噪音",
      summary: "KC 用 2026-06-14 当日复盘判断周日 move 是否符合 Blueprint：20 EMA 定位置，RSI/MACD 定质量，ATR 定现实目标。",
      hook: "KC 今天复盘不要比较谁抓到 Sunday move。Show me whether the EMA held, momentum confirmed, and ATR justified the target。",
      outline: [
        "开场：复盘 6月13日区间被测试后，周日 move 有没有尊重 20 EMA。",
        "位置：标出主图、20 EMA、周六高低点、周线收盘和第一次周日回踩的关系。",
        "确认：刷新后用 RSI、MACD 判断延续、拒绝还是低动能震荡。",
        "目标：用实时 ATR 检查 TP 是否现实，周末波动异常扩大时先缩小仓位。",
        "转化：要求成员提交 entry、SL、TP，并写明为何持有、减仓或不参与。"
      ],
      talk: [
        "KC 可以这样讲：a weak Sunday move fails when price cannot hold the EMA and momentum fades.",
        "守住 EMA 后的第一次回踩，复盘 clean continuation；跌回 EMA 下方，复盘为什么没有 entry。",
        "跨币分化、Gold 的弱周线背景和 ATR 变化都要求先执行纪律，再讨论方向。"
      ],
      contextLines: [
        "Use this as a June 14 Blueprint recap of live Sunday crypto against Saturday's range and the weekly close.",
        "Every conclusion should map to EMA location, momentum quality, ATR-based target, and a predefined weekend risk decision."
      ],
      marketTemplate: "刷新后如果主图在 20 EMA 上方且 RSI 守中线，主讲守线后的第一次回踩；如果价格低于 EMA、MACD 走弱、ATR 异常或跨币不确认，主讲短目标、离场或观望。",
      assignment: "让成员提交一张 6月14日复盘图，标出 20 EMA、6月13日区间、周线收盘、entry zone、SL、第一目标和实时 ATR 依据。"
    }
  },
  Caven: {
    "mon-market": {
      title: "Scalp 当日行情解读：6月14日只做周日边界反应",
      summary: "Caven 用 liquidity、VWAP 和 ATR 解读 2026-06-14：BTC/SOL 只交易 6月13日或周日 session 边界 sweep 后的 VWAP 回收与拒绝。",
      hook: "Caven 今天不要在 Sunday range 中间追。先刷新行情，把 SOL/BTC 的 6月13日 high/low、周线收盘、周日 session 边界和 VWAP 画出来。",
      outline: [
        "开场：说明 6月14日是 Sunday scalp day，重点是边界反应，不是延伸周六方向。",
        "流动性：标出 SOL/BTC 的 6月13日高低点、周线收盘、周日 session high/low 和最近清算区。",
        "VWAP：扫低并回收 VWAP 才讲 long scalp；扫高后跌回 VWAP 下方才讲 short scalp。",
        "波动：刷新后读取 RSI、MACD、ATR，并用 BTC、ETH、SOL 是否同步检查参与度。",
        "风险：周末区间中间、低 ATR 或失控扩张环境都不追单；Gold 周日闭市，只保留宏观背景。"
      ],
      talk: [
        "Caven 可以这样讲：Sunday volatility is not an entry. We trade the reaction at Saturday's high, low, the weekly close, or a fresh session edge.",
        "SOL 扫 session low、收回关键边界并站上 VWAP，而且 BTC 同步，才有 quick long scalp；扫高失去 VWAP 就讲 trap breakout。",
        "静态稿件不写死价格，最近 key levels 都来自刷新后的图表、6月13日区间与当日 session。"
      ],
      contextLines: [
        "The June 14 scalp backdrop is thinner Sunday liquidity after crypto sold off earlier in the week and spent the weekend testing acceptance.",
        "Gold's weak week under higher yields and a firm dollar is risk context only. Scalp triggers still come from boundary liquidity, VWAP, participation, ATR, and fast invalidation."
      ],
      marketTemplate: "刷新后如果 SOL/BTC 扫低、收回 6月13日或周日 session 边界并站上 VWAP，且实时 ATR 足够，主讲 quick long scalp；如果扫高失败、低于 VWAP 或卡在中间，主讲 short scalp 或等待。",
      assignment: "让成员提交 SOL 或 BTC 6月14日 15M 图，标出 6月13日 high/low、周线收盘、周日 session 边界、一次 sweep、VWAP、entry、SL 和第一止盈。"
    },
    "wed-market": {
      title: "Scalp 当日行情跟进：6月14日检查 Sunday VWAP reaction",
      summary: "Caven 用 liquidity、VWAP 和短线波动跟进 2026-06-14：只看 6月13日或周日边界被扫后的回收与拒绝，并用 ATR 判断是否还有 scalp 空间。",
      hook: "Caven 今天跟进先问三个问题：周日边界 sweep 了吗，VWAP 守住了吗，ATR 还可控吗？少一个就等。",
      outline: [
        "开场：把跟进定义成 Sunday reaction check，不追已经发生的第一段薄流动性扩张。",
        "流动性：确认 SOL/BTC 哪一侧 6月13日或周日 session liquidity 已被扫，哪一侧仍是下一目标。",
        "VWAP：扫低后回收并守住才讲 continuation；扫高后跌回下方就讲 trap breakout。",
        "波动：刷新后用 RSI、MACD、ATR 检查动能、空间与跨币同步。",
        "执行：区间中间、ATR 失控、VWAP 反复穿越都不是 clean scalp，失败要快速退出。"
      ],
      talk: [
        "Caven 可以这样讲：the reaction at the Sunday edge matters more than the size of the first candle.",
        "SOL 扫低后站回 VWAP、RSI 修复且 BTC 同步，可以讲 quick long scalp。",
        "价格回到 VWAP 又马上失守，shorten the target, close quickly, or skip the trade."
      ],
      contextLines: [
        "The June 14 follow-up focuses on whether price can hold VWAP after liquidity is taken at Saturday's range or a fresh Sunday session edge.",
        "Live ATR and cross-crypto participation decide whether the move has enough controlled range for a scalp."
      ],
      marketTemplate: "刷新后如果 SOL/BTC 在边界 sweep 后守住 VWAP、且 ATR 仍支持空间，主讲 Sunday scalp；如果价格低于 VWAP、ATR 失控或 RSI 没修复，主讲 failed retest 和等待。",
      assignment: "让成员提交 SOL 或 BTC 6月14日 15M 图，标出 6月13日与周日 session 边界、sweep、VWAP 回收或拒绝、entry、SL 和第一止盈。"
    },
    "fri-market": {
      title: "Scalp 当日复盘转化：6月14日只复盘 edge、sweep、VWAP",
      summary: "Caven 用 2026-06-14 当日复盘把 6月13日区间、周日 session sweep、VWAP、RSI 和 ATR 转成短线作业，中间位置不点评。",
      hook: "Caven 今天不复盘谁抓到周日方向，只复盘有没有 edge、sweep、VWAP reaction 和可控 ATR。",
      outline: [
        "开场：复盘周日最清楚的一次扫高或扫低，不用固定价格总结。",
        "流动性：标出 SOL/BTC 的 6月13日高低点、周线收盘、周日 session 边界和被扫的一侧。",
        "VWAP：确认 sweep 后是回收、拒绝，还是一直在中间震荡。",
        "波动：刷新后用 RSI、MACD、ATR 判断这笔 scalp 是否有足够且可控的空间。",
        "转化：止损必须放在 sweep 外侧，VWAP 失效就快速退出，不把 Sunday scalp 变成长仓。"
      ],
      talk: [
        "Caven 可以这样讲：the clean trade is the reaction after Sunday liquidity is taken and VWAP confirms.",
        "SOL 或 BTC 扫 session low 后站回 VWAP，并且 RSI 修复，复盘 clean long scalp；扫高后跌回 VWAP 下方就复盘 trap breakout。",
        "ATR 收缩时目标变小，ATR 失控时仓位变小，周末不留没有明确止损的方向仓位。"
      ],
      contextLines: [
        "Use this as the June 14 same-day scalp review against Saturday's range and the weekly close.",
        "Every recap should map to the weekend boundary, sweep, VWAP reaction, momentum, ATR space, and a clear exit decision."
      ],
      marketTemplate: "刷新后如果 SOL/BTC 的 ATR 仍支持可控空间且 RSI 修复，主讲扫低回收 VWAP；如果 ATR 失控、价格低于 VWAP 或卡在 session 中间，主讲缩小仓位、扫高失败或等待。",
      assignment: "让成员提交一张 6月14日 15M 复盘图，标出 6月13日 high/low、周线收盘、周日 session 边界、一次有效 sweep、VWAP、entry、SL 和第一止盈。"
    }
  }
};

const JUNE_13_MARKET_READOUT_OVERRIDES = {
  William: {
    "mon-market": {
      title: "ICT 当日行情解读：6月13日先读周线收盘后的周末流动性",
      summary: "William 用 ICT/SMC 解读 2026-06-13：BTC、ETH、SOL 在周线收盘后进入周末交易，先判断 6月12日区间哪侧被扫，再用 Gold 的最后交易时段表现交叉检查风险背景。",
      hook: "William 今天不要把周五收盘方向直接延伸到周末。刷新行情后，先标出 6月12日高低点、周线收盘位置和周末新形成的区间，看 liquidity sweep 后有没有真实 displacement。",
      outline: [
        "开场：把 6月13日定义成 post-weekly-close liquidity day，周末流动性偏薄，不追第一段扩张。",
        "关键位：标出 6月12日高低点、本周高低点、周线收盘位置和周末 session 边界。",
        "结构：扫低后需要 displacement、CHOCH 和回踩守住；扫高后跌回周末区间按 buy-side liquidity grab 处理。",
        "动能：刷新后比较 BTC、ETH、SOL 的 RSI、MACD、ATR，确认反应是否有跨币同步。",
        "风险：Gold 周六不交易，只把最后交易时段的反弹与整周弱势作为宏观背景；周末仓位必须更小并预设 invalidation。"
      ],
      talk: [
        "William 可以这样讲：on June 13, the weekly close is already fixed, but weekend acceptance is still being tested.",
        "BTC 与 ETH 若扫过 6月12日低点后同步回收，并形成 bullish CHOCH，再讲 discount retest；SOL 不参与就降低确定性。",
        "价格、RSI、MACD 和 ATR 全部由刷新行情写入口播，静态稿件只保留 liquidity、structure、confirmation 和 risk sequence。"
      ],
      contextLines: [
        "The June 13 backdrop is a thin-liquidity weekend after Bitcoin held relatively steady on Friday within a much larger drawdown. Treat the Friday range and weekly close as reference points, not automatic direction signals.",
        "Gold rebounded in its last open session but still ended a weak week. Because gold is closed on Saturday, use that move only as macro context while crypto structure remains the live trigger."
      ],
      marketTemplate: "刷新后如果 BTC/ETH 扫过 6月12日低点或周末 sell-side 后快速回收，并形成 displacement 与 CHOCH，主讲 FVG 或 order block 回踩；如果扫高失败、SOL 分化或 ATR 失控，主讲周末薄流动性诱多和等待。",
      assignment: "让成员提交 BTC 或 ETH 6月13日最新 4H 图，标出 6月12日高低点、周线收盘、周末区间、sweep、BOS/CHOCH、entry zone、SL 和第一目标。"
    },
    "wed-market": {
      title: "ICT 当日行情跟进：6月13日检验周末 acceptance 是否真实",
      summary: "William 用 ICT/SMC 跟进 2026-06-13：检查周线收盘后的 BTC、ETH、SOL 是形成可执行 acceptance，还是只在低流动性环境中扫过周五区间。",
      hook: "William 今天只回答一个问题：周末拿走 6月12日 liquidity 以后，市场留下的是可回踩的 structure，还是没有 follow-through 的 stop run？",
      outline: [
        "开场：说明当日跟进重点是 weekend acceptance quality，不用一根周末 K 线代替结构。",
        "流动性：观察 6月12日高低点、周线收盘与周末极值，确认 sweep 后价格被接受在哪一侧。",
        "结构：higher low、displacement 和回踩守住才讲修复；跌回 broken structure 就讲薄流动性假动作。",
        "动能：刷新后用 BTC、ETH、SOL 的 RSI、MACD、ATR 检查同步性与剩余空间。",
        "风险：Gold 保留最后交易时段数据但周六不更新；crypto 若缺少 breadth 与 invalidation，不扩大周末仓位。"
      ],
      talk: [
        "William 可以这样讲：weekend acceptance matters only when the structure shift survives a retest with cross-crypto participation.",
        "BTC 与 ETH 同步守住、SOL 参与，才讲 continuation；单币回抽或扫高回落，只算 weekend readout，不算 full-size entry。",
        "RSI、MACD 和 ATR 负责验证动能与空间，entry 仍来自 liquidity、structure 和 invalidation。"
      ],
      contextLines: [
        "June 13 should separate durable post-close acceptance from a temporary weekend stop run around Friday's range.",
        "Crypto breadth is the live confirmation. Gold's last-session rebound and weak weekly finish remain background evidence, not a Saturday execution signal."
      ],
      marketTemplate: "刷新后如果 BTC/ETH 在 6月12日区间边缘扫单回收、形成 higher low 且 SOL 同步，主讲 CHOCH 后回踩；如果扫高失败、ATR 异常或跌回 broken structure，主讲周末假 acceptance 和二次派发。",
      assignment: "让成员提交 BTC 或 ETH 6月13日最新 4H 图，标出周五区间、周线收盘、周末极值、sweep、displacement、BOS/CHOCH、retest、SL 和第一目标。"
    },
    "fri-market": {
      title: "ICT 当日复盘转化：6月13日只保留周末确认的结构",
      summary: "William 用 2026-06-13 当日复盘筛选周线收盘后的有效结构，只保留 liquidity、acceptance、structure shift、retest 和 invalidation 完整的周末计划。",
      hook: "William 今天不复盘谁猜对周末方向，只复盘 6月13日有没有把 Friday range liquidity 转成完整、可验证的 sequence。",
      outline: [
        "开场：复盘周末市场对 6月12日区间和周线收盘位置的接受或拒绝。",
        "流动性：回看周五高低点、周末极值和 session 边界中最清楚的一次 sweep。",
        "结构：把 acceptance、BOS/CHOCH、FVG 或 order block 回踩和 invalidation 画完整。",
        "动能：刷新后用 BTC/ETH 的 RSI、MACD、ATR，并参考 SOL 是否同步验证结论。",
        "风险：Gold 周六闭市，只保留宏观背景；不为不完整 sequence 留高杠杆周末仓位。"
      ],
      talk: [
        "William 可以这样讲：the lesson is whether weekend price action earned acceptance beyond Friday's range.",
        "只有 sweep、displacement、CHOCH 和 retest 都出现，才是 ICT setup；只有快速扩张或单币领先不是 entry。",
        "ATR 扩张时缩小仓位，ATR 收缩时缩小目标，没有 invalidation 就记录 no trade。"
      ],
      contextLines: [
        "Use this as the June 13 same-day review of whether weekend crypto confirmed or rejected the move around Friday's range and weekly close.",
        "Reward confirmed structure and broad participation, not prediction, candle size, or a stale gold quote while that market is closed."
      ],
      marketTemplate: "刷新后如果 BTC/ETH 已给出 sweep + acceptance + displacement + CHOCH + retest，主讲确认后的计划；如果扫高回落、SOL 不同步或动能衰减，主讲为什么周末没有 entry。",
      assignment: "让成员提交一张 6月13日复盘图，标出周五区间、周线收盘、周末高低点、sweep、acceptance、BOS/CHOCH、回踩区、SL 和第一目标。"
    }
  },
  KC: {
    "mon-market": {
      title: "20 EMA 当日行情解读：6月13日让周末行情先通过 Blueprint",
      summary: "KC 用 20 EMA Blueprint 解读 2026-06-13：BTC、ETH、SOL 先检查周线收盘后的均线位置、动能和 ATR，Gold 只采用最后交易时段作为风险背景。",
      hook: "KC 今天不要把 Friday close 自动当成 weekend continuation。刷新行情后先回答：is crypto above the 20 EMA, below it, or only making a thin-liquidity reclaim?",
      outline: [
        "开场：把 6月13日定义成 weekend Blueprint check，不追离均线太远的周末扩张。",
        "位置：标出主图 20 EMA、6月12日高低点、周线收盘和周末第一次回踩。",
        "确认：价格在 EMA 正确一侧并得到实时 RSI、MACD 配合，才算 clean hold 或 reclaim。",
        "目标：用实时 ATR 约束 TP；BTC、ETH、SOL 若分化，主动缩小仓位和目标。",
        "风险：Gold 周六闭市，最后交易时段的反弹与周线弱势只做背景；没有 Blueprint 确认就继续等。"
      ],
      talk: [
        "KC 可以这样讲：on the weekend, the Blueprint starts with location. No clean EMA hold or reclaim means no clean setup.",
        "价格守住 20 EMA、RSI 守中线且 MACD 改善，才讲 first pullback；低流动性 reclaim 碰到 EMA 后再次被拒绝就等。",
        "具体报价与指标由刷新后的页面提供，静态稿件只定义位置、确认、止损和目标流程。"
      ],
      contextLines: [
        "The June 13 setup is a weekend location check after Bitcoin traded steadily on Friday but remained inside a much broader decline.",
        "Gold's last open session rebounded while the weekly picture stayed weak. Since gold is closed, use it as context and let live crypto EMA location, breadth, and ATR drive the setup."
      ],
      marketTemplate: "刷新后如果主图守住或重新 reclaim 20 EMA，RSI/MACD 配合且第一次回踩稳定，主讲 weekend continuation；如果失去 EMA、跨币分化或 ATR 不支持目标，主讲 thin-liquidity failed reclaim。",
      assignment: "让成员提交 BTC 或 SOL 6月13日最新图，标出 20 EMA、6月12日高低点、周线收盘、周末第一次回踩、entry、SL 和实时 ATR 目标。"
    },
    "wed-market": {
      title: "20 EMA 当日行情跟进：6月13日守线才算周末确认",
      summary: "KC 用 20 EMA Blueprint 跟进 2026-06-13：第一次周末回踩是否守线、RSI/MACD 是否确认、ATR 是否支持目标，决定是否参与。",
      hook: "KC 今天的 quality check 很简单：did the EMA hold after the weekly close? 守不住均线，就没有 clean weekend continuation setup。",
      outline: [
        "开场：把跟进定义成 weekend first-pullback check，避免追离均线太远的位置。",
        "位置：检查主图是否贴近 20 EMA，以及周末回踩是否守在均线正确一侧。",
        "确认：刷新后用 RSI 中线和 MACD 柱体判断是真修复、趋势延续还是低流动性回抽。",
        "目标：用实时 ATR 制定第一目标；跨币分化或波动异常扩大时降低仓位。",
        "风险：Gold 的最后交易时段信号只代表宏观环境，周六不能替代 crypto Blueprint 的实时确认。"
      ],
      talk: [
        "KC 可以这样讲：weekend confirmation means the EMA hold survives the first pullback after the weekly close.",
        "BTC 在 EMA 上方但 ETH 或 SOL 不确认，可以有 readout，但不一定有 full-size trade。",
        "价格碰到 EMA 后立即被拒绝，this is resistance, not a late weekend long entry."
      ],
      contextLines: [
        "The June 13 follow-up tests whether the post-close move can hold through a first pullback in thinner weekend liquidity.",
        "Live 20 EMA location, cross-crypto participation, and ATR carry more weight than Friday's candle or gold's unchanged Saturday quote."
      ],
      marketTemplate: "刷新后如果主图在 20 EMA 上方完成第一次周末回踩、RSI 守中线且 MACD 改善，主讲 continuation；如果跌回 EMA 下方、ATR 异常或跨币分化，主讲 fake reclaim 和等待。",
      assignment: "让成员提交 BTC 或 SOL 6月13日最新图，标出 20 EMA、周五区间、周线收盘、第一次周末回踩、entry zone、SL 和实时 ATR 第一目标。"
    },
    "fri-market": {
      title: "20 EMA 当日复盘转化：6月13日让 ATR 过滤周末噪音",
      summary: "KC 用 2026-06-13 当日复盘判断周末 move 是否符合 Blueprint：20 EMA 定位置，RSI/MACD 定质量，ATR 定现实目标。",
      hook: "KC 今天复盘不要比较谁抓到 weekend move。Show me whether the EMA held, momentum confirmed, and ATR justified the target。",
      outline: [
        "开场：复盘周线收盘后的 move 有没有尊重 20 EMA。",
        "位置：标出主图、20 EMA、6月12日高低点、周线收盘和第一次周末回踩的关系。",
        "确认：刷新后用 RSI、MACD 判断延续、拒绝还是低动能震荡。",
        "目标：用实时 ATR 检查 TP 是否现实，周末波动异常扩大时先缩小仓位。",
        "转化：要求成员提交 entry、SL、TP，并写明为何持有、减仓或不参与。"
      ],
      talk: [
        "KC 可以这样讲：a weak weekend move fails when price cannot hold the EMA and momentum fades.",
        "守住 EMA 后的第一次回踩，复盘 clean continuation；跌回 EMA 下方，复盘为什么没有 entry。",
        "跨币分化、Gold 的最后交易时段背景和 ATR 变化都要求先执行纪律，再讨论方向。"
      ],
      contextLines: [
        "Use this as a June 13 Blueprint recap of live weekend crypto after the weekly close.",
        "Every conclusion should map to EMA location, momentum quality, ATR-based target, and a predefined weekend risk decision."
      ],
      marketTemplate: "刷新后如果主图在 20 EMA 上方且 RSI 守中线，主讲守线后的第一次回踩；如果价格低于 EMA、MACD 走弱、ATR 异常或跨币不确认，主讲短目标、离场或观望。",
      assignment: "让成员提交一张 6月13日复盘图，标出 20 EMA、周五区间、周线收盘、entry zone、SL、第一目标和实时 ATR 依据。"
    }
  },
  Caven: {
    "mon-market": {
      title: "Scalp 当日行情解读：6月13日只做周末边界反应",
      summary: "Caven 用 liquidity、VWAP 和 ATR 解读 2026-06-13：BTC/SOL 只交易 6月12日或周末 session 边界 sweep 后的 VWAP 回收与拒绝。",
      hook: "Caven 今天不要在 weekend range 中间追。先刷新行情，把 SOL/BTC 的 6月12日 high/low、周线收盘、周末 session 边界和 VWAP 画出来。",
      outline: [
        "开场：说明 6月13日是 weekend scalp day，重点是边界反应，不是延伸周五方向。",
        "流动性：标出 SOL/BTC 的 6月12日高低点、周线收盘、周末 session high/low 和最近清算区。",
        "VWAP：扫低并回收 VWAP 才讲 long scalp；扫高后跌回 VWAP 下方才讲 short scalp。",
        "波动：刷新后读取 RSI、MACD、ATR，并用 BTC、ETH、SOL 是否同步检查参与度。",
        "风险：周末区间中间、低 ATR 或失控扩张环境都不追单；Gold 周六闭市，只保留宏观背景。"
      ],
      talk: [
        "Caven 可以这样讲：weekend volatility is not an entry. We trade the reaction at Friday's high, low, weekly close, or a fresh session edge.",
        "SOL 扫 session low、收回关键边界并站上 VWAP，而且 BTC 同步，才有 quick long scalp；扫高失去 VWAP 就讲 trap breakout。",
        "静态稿件不写死价格，最近 key levels 都来自刷新后的图表、周五区间与当日 session。"
      ],
      contextLines: [
        "The June 13 scalp backdrop is thinner weekend liquidity after Bitcoin held relatively steady on Friday inside a broader decline.",
        "Gold's rebound and weak weekly finish are risk context only. Crypto scalp triggers still come from boundary liquidity, VWAP, participation, ATR, and fast invalidation."
      ],
      marketTemplate: "刷新后如果 SOL/BTC 扫低、收回 6月12日或周末 session 边界并站上 VWAP，且实时 ATR 足够，主讲 quick long scalp；如果扫高失败、低于 VWAP 或卡在中间，主讲 short scalp 或等待。",
      assignment: "让成员提交 SOL 或 BTC 6月13日 15M 图，标出 6月12日 high/low、周线收盘、周末 session 边界、一次 sweep、VWAP、entry、SL 和第一止盈。"
    },
    "wed-market": {
      title: "Scalp 当日行情跟进：6月13日检查 weekend VWAP reaction",
      summary: "Caven 用 liquidity、VWAP 和短线波动跟进 2026-06-13：只看周五或周末边界被扫后的回收或拒绝，并用 ATR 判断是否还有 scalp 空间。",
      hook: "Caven 今天跟进先问三个问题：周末边界 sweep 了吗，VWAP 守住了吗，ATR 还可控吗？少一个就等。",
      outline: [
        "开场：把跟进定义成 weekend reaction check，不追已经发生的第一段薄流动性扩张。",
        "流动性：确认 SOL/BTC 哪一侧周五或周末 session liquidity 已被扫，哪一侧仍是下一目标。",
        "VWAP：扫低后回收并守住才讲 continuation；扫高后跌回下方就讲 trap breakout。",
        "波动：刷新后用 RSI、MACD、ATR 检查动能、空间与跨币同步。",
        "执行：区间中间、ATR 失控、VWAP 反复穿越都不是 clean scalp，失败要快速退出。"
      ],
      talk: [
        "Caven 可以这样讲：the reaction at the weekend edge matters more than the size of the first candle.",
        "SOL 扫低后站回 VWAP、RSI 修复且 BTC 同步，可以讲 quick long scalp。",
        "价格回到 VWAP 又马上失守，shorten the target, close quickly, or skip the trade."
      ],
      contextLines: [
        "The June 13 follow-up focuses on whether price can hold VWAP after liquidity is taken at Friday's range or a fresh weekend session edge.",
        "Live ATR and cross-crypto participation decide whether the move has enough controlled range for a scalp."
      ],
      marketTemplate: "刷新后如果 SOL/BTC 在边界 sweep 后守住 VWAP、且 ATR 仍支持空间，主讲 weekend scalp；如果价格低于 VWAP、ATR 失控或 RSI 没修复，主讲 failed retest 和等待。",
      assignment: "让成员提交 SOL 或 BTC 6月13日 15M 图，标出周五与周末 session 边界、sweep、VWAP 回收或拒绝、entry、SL 和第一止盈。"
    },
    "fri-market": {
      title: "Scalp 当日复盘转化：6月13日只复盘 edge、sweep、VWAP",
      summary: "Caven 用 2026-06-13 当日复盘把周五区间、周末 session sweep、VWAP、RSI 和 ATR 转成短线作业，中间位置不点评。",
      hook: "Caven 今天不复盘谁抓到周末方向，只复盘有没有 edge、sweep、VWAP reaction 和可控 ATR。",
      outline: [
        "开场：复盘周末最清楚的一次扫高或扫低，不用固定价格总结。",
        "流动性：标出 SOL/BTC 的 6月12日高低点、周线收盘、周末 session 边界和被扫的一侧。",
        "VWAP：确认 sweep 后是回收、拒绝，还是一直在中间震荡。",
        "波动：刷新后用 RSI、MACD、ATR 判断这笔 scalp 是否有足够且可控的空间。",
        "转化：止损必须放在 sweep 外侧，VWAP 失效就快速退出，不把 weekend scalp 变成长仓。"
      ],
      talk: [
        "Caven 可以这样讲：the clean trade is the reaction after weekend liquidity is taken and VWAP confirms.",
        "SOL 或 BTC 扫 session low 后站回 VWAP，并且 RSI 修复，复盘 clean long scalp；扫高后跌回 VWAP 下方就复盘 trap breakout。",
        "ATR 收缩时目标变小，ATR 失控时仓位变小，周末不留没有明确止损的方向仓位。"
      ],
      contextLines: [
        "Use this as the June 13 same-day scalp review after the weekly close.",
        "Every recap should map to Friday or weekend boundary, sweep, VWAP reaction, momentum, ATR space, and a clear exit decision."
      ],
      marketTemplate: "刷新后如果 SOL/BTC 的 ATR 仍支持可控空间且 RSI 修复，主讲扫低回收 VWAP；如果 ATR 失控、价格低于 VWAP 或卡在 session 中间，主讲缩小仓位、扫高失败或等待。",
      assignment: "让成员提交一张 6月13日 15M 复盘图，标出 6月12日 high/low、周线收盘、周末 session 边界、一次有效 sweep、VWAP、entry、SL 和第一止盈。"
    }
  }
};

const JUNE_12_MARKET_READOUT_OVERRIDES = {
  William: {
    "mon-market": {
      title: "ICT 当日行情解读：6月12日先读周线收盘前的流动性选择",
      summary: "William 用 ICT/SMC 解读 2026-06-12：BTC、ETH、SOL 进入周线收盘前的方向选择，Gold 用作风险与利率背景交叉检查，先看流动性再看结构。",
      hook: "William 今天不要先猜周线收在哪里。刷新行情后，标出 6月11日高低点、本周高低点、亚洲盘边界和最近清算区，看哪一侧 liquidity 先被拿走。",
      outline: [
        "开场：把 6月12日定义成 weekly-close positioning day，先读流动性选择，不追第一段扩张。",
        "关键位：标出 6月11日高低点、本周高低点、当日 session 边界和最近清算区。",
        "结构：扫低后需要 displacement、CHOCH 和回踩守住；扫高后跌回区间按 buy-side liquidity grab 处理。",
        "动能：刷新后比较 BTC、ETH、SOL 的 RSI、MACD、ATR，确认主流币是否同步。",
        "风险：周末前波动与 headline risk 可能放大，Gold 只做宏观交叉检查，没有 invalidation 不留高杠杆仓位。"
      ],
      talk: [
        "William 可以这样讲：on June 12, the weekly close is not a prediction. It is a liquidity and acceptance test.",
        "BTC 与 ETH 若在前一日或周内低点扫单回收，并形成 bullish CHOCH，再讲 discount retest；SOL 不同步就降低确定性。",
        "价格、RSI、MACD 和 ATR 全部由刷新行情写入口播，静态稿件只保留结构、关键位和风险流程。"
      ],
      contextLines: [
        "The June 12 backdrop is a weekly-close positioning session after a volatile risk-sensitive stretch. Treat prior-day and weekly extremes as decision zones, not automatic entries.",
        "Crypto breadth and gold's reaction to rates and risk headlines should be cross-checks. The trade still requires liquidity, structure confirmation, and a clear invalidation."
      ],
      marketTemplate: "刷新后如果 BTC/ETH 扫过 6月11日低点或本周 sell-side 后快速回收，并形成 displacement 与 CHOCH，主讲 FVG 或 order block 回踩；如果扫高失败、SOL 分化或 MACD 走弱，主讲周末前派发和等待。",
      assignment: "让成员提交 BTC 或 ETH 6月12日最新 4H 图，标出 6月11日高低点、本周高低点、sweep、BOS/CHOCH、entry zone、SL 和第一目标。"
    },
    "wed-market": {
      title: "ICT 当日行情跟进：6月12日检验 acceptance 能否守到周线收盘",
      summary: "William 用 ICT/SMC 跟进 2026-06-12：检查前一日区间被扫后，BTC、ETH、SOL 是否形成能守到周线收盘的 acceptance 与结构。",
      hook: "William 今天只回答一个问题：前一日 liquidity 被拿走以后，市场留下的是可执行的 structure，还是周末前的短暂回抽？",
      outline: [
        "开场：说明当日跟进重点是 acceptance quality，不用一根反弹或下跌 K 线代替结构。",
        "流动性：观察 6月11日高低点与本周极值，确认 sweep 后价格被接受在哪一侧。",
        "结构：higher low、displacement 和回踩守住才讲修复；跌回 broken structure 就讲弱反抽或派发。",
        "动能：刷新后用 BTC、ETH、SOL 的 RSI、MACD、ATR 检查同步性与剩余空间。",
        "风险：周线收盘和周末 headline risk 都会提高跳空风险，没有清楚止损就不扩大仓位。"
      ],
      talk: [
        "William 可以这样讲：acceptance matters only when the structure shift survives the retest into the weekly close.",
        "BTC 与 ETH 同步守住、SOL 参与，才讲 continuation；单币回抽或扫高回落，只算 readout，不算 full-size entry。",
        "RSI、MACD 和 ATR 负责验证动能与空间，entry 仍来自 liquidity、structure 和 invalidation。"
      ],
      contextLines: [
        "June 12 should separate durable acceptance from a temporary rebound or rejection before the weekly close.",
        "Broad crypto participation matters. Gold remains a macro cross-check, while execution stays anchored to live chart structure."
      ],
      marketTemplate: "刷新后如果 BTC/ETH 在 6月11日区间边缘扫单回收、形成 higher low 且 SOL 同步，主讲 CHOCH 后回踩；如果扫高失败、ATR 收缩或跌回 broken structure，主讲周末前弱反抽和二次派发。",
      assignment: "让成员提交 BTC 或 ETH 6月12日最新 4H 图，标出前一日区间、本周极值、sweep、displacement、BOS/CHOCH、retest、SL 和第一目标。"
    },
    "fri-market": {
      title: "ICT 当日复盘转化：6月12日只保留周线收盘确认的结构",
      summary: "William 用 2026-06-12 当日复盘筛选周线收盘前后的有效结构，只保留 liquidity、acceptance、structure shift、retest 和 invalidation 完整的计划。",
      hook: "William 今天不复盘谁猜对周线方向，只复盘 6月12日有没有把 liquidity move 转成完整、可验证的 sequence。",
      outline: [
        "开场：复盘周线收盘前市场对前一日与本周关键区间的接受或拒绝。",
        "流动性：回看 6月11日高低点、本周极值和当日 session 边界中最清楚的一次 sweep。",
        "结构：把 acceptance、BOS/CHOCH、FVG 或 order block 回踩和 invalidation 画完整。",
        "动能：刷新后用 BTC/ETH 的 RSI、MACD、ATR，并参考 SOL 是否同步验证结论。",
        "风险：周末不为不完整 sequence 留高杠杆仓位；Gold 与宏观 headline 只用于调整风险。"
      ],
      talk: [
        "William 可以这样讲：the lesson is whether the market earned acceptance into the weekly close.",
        "只有 sweep、displacement、CHOCH 和 retest 都出现，才是 ICT setup；只有快速扩张或单币领先不是 entry。",
        "ATR 扩张时缩小仓位，ATR 收缩时缩小目标，没有 invalidation 就记录 no trade。"
      ],
      contextLines: [
        "Use this as the June 12 same-day review of whether the weekly close confirmed or rejected the market's liquidity move.",
        "Reward confirmed structure and broad participation, not prediction, candle size, or weekend position bias."
      ],
      marketTemplate: "刷新后如果 BTC/ETH 已给出 sweep + acceptance + displacement + CHOCH + retest，主讲确认后的计划；如果扫高回落、SOL 不同步或动能衰减，主讲为什么周末前没有 entry。",
      assignment: "让成员提交一张 6月12日复盘图，标出前一日区间、本周高低点、sweep、acceptance、BOS/CHOCH、回踩区、SL 和第一目标。"
    }
  },
  KC: {
    "mon-market": {
      title: "20 EMA 当日行情解读：6月12日让周线收盘先通过 Blueprint",
      summary: "KC 用 20 EMA Blueprint 解读 2026-06-12：BTC、ETH、SOL 与 Gold 都先检查均线位置、动能和 ATR，再决定周线收盘前是否有 clean setup。",
      hook: "KC 今天不要先问 weekly close 会涨还是跌。刷新行情后先回答：is price above the 20 EMA, below it, or testing a reclaim near a key weekly level?",
      outline: [
        "开场：把 6月12日定义成 weekly-close Blueprint check，不追离均线太远的扩张。",
        "位置：标出主图 20 EMA、6月11日高低点、本周高低点和当日第一次回踩。",
        "确认：价格在 EMA 正确一侧并得到实时 RSI、MACD 配合，才算 clean hold 或 reclaim。",
        "目标：用实时 ATR 约束 TP；BTC、ETH、SOL 若分化，主动缩小仓位和目标。",
        "风险：Gold 与宏观 headline 用作风险交叉检查，周末前没有 Blueprint 确认就继续等。"
      ],
      talk: [
        "KC 可以这样讲：before the weekly close, the Blueprint starts with location. No clean EMA hold or reclaim means no clean setup.",
        "价格守住 20 EMA、RSI 守中线且 MACD 改善，才讲 first pullback；碰到 EMA 后再次被拒绝就等。",
        "具体报价与指标由刷新后的页面提供，静态稿件只定义位置、确认、止损和目标流程。"
      ],
      contextLines: [
        "The June 12 setup is a weekly-close location check across crypto and gold after a volatile risk-sensitive week.",
        "Use live 20 EMA location, momentum, breadth, and ATR. Do not turn a Friday move or macro headline into an automatic direction call."
      ],
      marketTemplate: "刷新后如果主图守住或重新 reclaim 20 EMA，RSI/MACD 配合且第一次回踩稳定，主讲 weekly-close continuation；如果失去 EMA、跨币分化或 ATR 不支持目标，主讲 failed reclaim。",
      assignment: "让成员提交 BTC、Gold 或 SOL 6月12日最新图，标出 20 EMA、6月11日高低点、本周极值、第一次回踩、entry、SL 和实时 ATR 目标。"
    },
    "wed-market": {
      title: "20 EMA 当日行情跟进：6月12日守线才算周末前确认",
      summary: "KC 用 20 EMA Blueprint 跟进 2026-06-12：第一次回踩是否守线、RSI/MACD 是否确认、ATR 是否支持目标，决定周末前能否参与。",
      hook: "KC 今天的 quality check 很简单：did the EMA hold into the weekly close? 守不住均线，就没有 clean continuation setup。",
      outline: [
        "开场：把跟进定义成 first-pullback check，避免在周线收盘前追离均线太远的位置。",
        "位置：检查主图是否贴近 20 EMA，以及回踩是否守在均线正确一侧。",
        "确认：刷新后用 RSI 中线和 MACD 柱体判断是真修复、趋势延续还是被动回抽。",
        "目标：用实时 ATR 制定第一目标；跨币分化或波动异常扩大时降低仓位。",
        "风险：Gold 若与风险资产给出不同信号，只代表宏观环境复杂，不代表可以跳过 Blueprint。"
      ],
      talk: [
        "KC 可以这样讲：weekly-close confirmation means the EMA hold survives the first pullback.",
        "BTC 在 EMA 上方但 ETH 或 SOL 不确认，可以有 readout，但不一定有 full-size trade。",
        "价格碰到 EMA 后立即被拒绝，this is resistance, not a late long entry."
      ],
      contextLines: [
        "The June 12 follow-up should test whether the current move can hold through a first pullback into the weekly close.",
        "Live 20 EMA location, cross-crypto participation, and ATR carry more weight than the size of the Friday candle."
      ],
      marketTemplate: "刷新后如果主图在 20 EMA 上方完成第一次回踩、RSI 守中线且 MACD 改善，主讲 continuation；如果跌回 EMA 下方、ATR 异常或跨币分化，主讲 fake reclaim 和等待。",
      assignment: "让成员提交 BTC、Gold 或 SOL 6月12日最新图，标出 20 EMA、前一日与本周关键位、第一次回踩、entry zone、SL 和实时 ATR 第一目标。"
    },
    "fri-market": {
      title: "20 EMA 当日复盘转化：6月12日让 ATR 过滤周线噪音",
      summary: "KC 用 2026-06-12 当日复盘判断周线收盘是否符合 Blueprint：20 EMA 定位置，RSI/MACD 定质量，ATR 定现实目标。",
      hook: "KC 今天复盘不要比较谁抓到 Friday move。Show me whether the EMA held, momentum confirmed, and ATR justified the target。",
      outline: [
        "开场：复盘周线收盘前后的 move 有没有尊重 20 EMA。",
        "位置：标出主图、20 EMA、6月11日高低点、本周极值和第一次回踩的关系。",
        "确认：刷新后用 RSI、MACD 判断延续、拒绝还是低动能震荡。",
        "目标：用实时 ATR 检查 TP 是否现实，波动异常扩大时先缩小仓位。",
        "转化：要求成员提交 entry、SL、TP，并写明周末前为何持有或不持有。"
      ],
      talk: [
        "KC 可以这样讲：a weak weekly close fails when price cannot hold the EMA and momentum fades.",
        "守住 EMA 后的第一次回踩，复盘 clean continuation；跌回 EMA 下方，复盘为什么没有 entry。",
        "跨币分化、Gold 的风险信号和 ATR 变化都要求先执行纪律，再讨论方向。"
      ],
      contextLines: [
        "Use this as a June 12 Blueprint recap of the weekly close across BTC, ETH, SOL, and gold.",
        "Every conclusion should map to EMA location, momentum quality, ATR-based target, and a predefined weekend risk decision."
      ],
      marketTemplate: "刷新后如果主图在 20 EMA 上方且 RSI 守中线，主讲守线后的第一次回踩；如果价格低于 EMA、MACD 走弱、ATR 异常或跨币不确认，主讲短目标、离场或观望。",
      assignment: "让成员提交一张 6月12日复盘图，标出 20 EMA、前一日与本周关键位、entry zone、SL、第一目标和实时 ATR 依据。"
    }
  },
  Caven: {
    "mon-market": {
      title: "Scalp 当日行情解读：6月12日只做周线收盘前的边界反应",
      summary: "Caven 用 liquidity、VWAP 和 ATR 解读 2026-06-12：BTC/SOL 只交易前一日、本周或 session 边界 sweep 后的 VWAP 回收与拒绝。",
      hook: "Caven 今天不要在 Friday move 中间追。先刷新行情，把 SOL/BTC 的 6月11日 high/low、本周高低点、当日 session 边界和 VWAP 画出来。",
      outline: [
        "开场：说明 6月12日是 weekly-close scalp day，重点是边界反应，不是方向口号。",
        "流动性：标出 SOL/BTC 前一日高低点、本周极值、当日 session high/low 和最近清算区。",
        "VWAP：扫低并回收 VWAP 才讲 long scalp；扫高后跌回 VWAP 下方才讲 short scalp。",
        "波动：刷新后读取 RSI、MACD、ATR，并用 BTC、ETH、SOL 是否同步检查参与度。",
        "风险：周末前区间中间、低 ATR 或失控扩张环境都不追单，不留没有止损的高杠杆仓位。"
      ],
      talk: [
        "Caven 可以这样讲：Friday volatility is not an entry. We trade the reaction at the prior-day, weekly, or session edge.",
        "SOL 扫 session low、收回关键边界并站上 VWAP，而且 BTC 同步，才有 quick long scalp；扫高失去 VWAP 就讲 trap breakout。",
        "静态稿件不写死价格，最近 key levels 都来自刷新后的图表与当日 session。"
      ],
      contextLines: [
        "The June 12 scalp backdrop is a weekly-close session where prior-day, weekly, and session edges can attract liquidity.",
        "Gold and macro headlines are risk context only. Crypto scalp triggers still come from liquidity, VWAP, participation, ATR, and fast invalidation."
      ],
      marketTemplate: "刷新后如果 SOL/BTC 扫低、收回前一日、本周或 session 边界并站上 VWAP，且实时 ATR 足够，主讲 quick long scalp；如果扫高失败、低于 VWAP 或卡在中间，主讲 short scalp 或等待。",
      assignment: "让成员提交 SOL 或 BTC 6月12日 15M 图，标出 6月11日 high/low、本周极值、session 边界、一次 sweep、VWAP、entry、SL 和第一止盈。"
    },
    "wed-market": {
      title: "Scalp 当日行情跟进：6月12日检查 weekly-close VWAP reaction",
      summary: "Caven 用 liquidity、VWAP 和短线波动跟进 2026-06-12：只看关键边界被扫后的回收或拒绝，并用 ATR 判断周线收盘前是否还有 scalp 空间。",
      hook: "Caven 今天跟进先问三个问题：边界 sweep 了吗，VWAP 守住了吗，ATR 还可控吗？少一个就等。",
      outline: [
        "开场：把跟进定义成 weekly-close reaction check，不追已经发生的第一段扩张。",
        "流动性：确认 SOL/BTC 哪一侧前一日、本周或 session liquidity 已被扫，哪一侧仍是下一目标。",
        "VWAP：扫低后回收并守住才讲 continuation；扫高后跌回下方就讲 trap breakout。",
        "波动：刷新后用 RSI、MACD、ATR 检查动能、空间与跨币同步。",
        "执行：区间中间、ATR 失控、VWAP 反复穿越都不是 clean scalp，周末前失败要快速退出。"
      ],
      talk: [
        "Caven 可以这样讲：the reaction at the edge matters more than the size of the Friday candle.",
        "SOL 扫低后站回 VWAP、RSI 修复且 BTC 同步，可以讲 quick long scalp。",
        "价格回到 VWAP 又马上失守，shorten the target, close quickly, or skip the trade."
      ],
      contextLines: [
        "The June 12 follow-up focuses on whether price can hold VWAP after liquidity is taken at a prior-day, weekly, or session edge.",
        "Live ATR and cross-crypto participation decide whether the move has enough controlled range for a scalp before the weekly close."
      ],
      marketTemplate: "刷新后如果 SOL/BTC 在边界 sweep 后守住 VWAP、且 ATR 仍支持空间，主讲 weekly-close scalp；如果价格低于 VWAP、ATR 失控或 RSI 没修复，主讲 failed retest 和等待。",
      assignment: "让成员提交 SOL 或 BTC 6月12日 15M 图，标出前一日、本周和 session 边界、sweep、VWAP 回收或拒绝、entry、SL 和第一止盈。"
    },
    "fri-market": {
      title: "Scalp 当日复盘转化：6月12日只复盘 edge、sweep、VWAP",
      summary: "Caven 用 2026-06-12 当日复盘把前一日与本周边界、session sweep、VWAP、RSI 和 ATR 转成短线作业，中间位置不点评。",
      hook: "Caven 今天不复盘谁抓到周线方向，只复盘有没有 edge、sweep、VWAP reaction 和可控 ATR。",
      outline: [
        "开场：复盘周线收盘前最清楚的一次扫高或扫低，不用固定价格总结。",
        "流动性：标出 SOL/BTC 前一日高低点、本周极值、当日 session 边界和被扫的一侧。",
        "VWAP：确认 sweep 后是回收、拒绝，还是一直在中间震荡。",
        "波动：刷新后用 RSI、MACD、ATR 判断这笔 scalp 是否有足够且可控的空间。",
        "转化：止损必须放在 sweep 外侧，VWAP 失效就快速退出，周末前不把 scalp 变成长仓。"
      ],
      talk: [
        "Caven 可以这样讲：the clean trade is the reaction after liquidity is taken and VWAP confirms.",
        "SOL 或 BTC 扫 session low 后站回 VWAP，并且 RSI 修复，复盘 clean long scalp；扫高后跌回 VWAP 下方就复盘 trap breakout。",
        "ATR 收缩时目标变小，ATR 失控时仓位变小，周末前不留没有明确止损的方向仓位。"
      ],
      contextLines: [
        "Use this as the June 12 same-day scalp review into the weekly close.",
        "Every recap should map to boundary, sweep, VWAP reaction, momentum, ATR space, and a clear weekend exit decision."
      ],
      marketTemplate: "刷新后如果 SOL/BTC 的 ATR 仍支持可控空间且 RSI 修复，主讲扫低回收 VWAP；如果 ATR 失控、价格低于 VWAP 或卡在 session 中间，主讲缩小仓位、扫高失败或等待。",
      assignment: "让成员提交一张 6月12日 15M 复盘图，标出前一日与本周 high/low、session 边界、一次有效 sweep、VWAP、entry、SL 和第一止盈。"
    }
  }
};

const JUNE_11_MARKET_READOUT_OVERRIDES = {
  William: {
    "mon-market": {
      title: "ICT 当日行情解读：6月11日先处理 risk-off 后的区间接受度",
      summary: "William 用 ICT/SMC 解读 2026-06-11：BTC、ETH、SOL 正在消化前一日风险冲击，Gold 的破位与高利率预期继续要求先看流动性和接受度。",
      hook: "William 今天不要在 risk-off 后第一段反应里猜底。先刷新行情，标出 6月10日高低点、当日 session 边界和最近清算区，再看 sweep 后市场接受在哪一侧。",
      outline: [
        "开场：把 6月11日定义成 risk-off digestion day，先判断区间接受度，不预设 V 型反转。",
        "流动性：标出 6月10日高低点、当日亚洲盘边界、近期清算低点和反弹供应区。",
        "结构：扫低后需要 displacement、CHOCH 和回踩守住；扫高后跌回前一日区间则按 liquidity grab 处理。",
        "动能：刷新后比较 BTC/ETH 的 RSI、MACD、ATR，并用 SOL 是否同步判断修复广度。",
        "风险：通胀、收益率和地缘冲突仍压制风险偏好；Gold 破位时不把 crypto 的单次回抽讲成趋势恢复。"
      ],
      talk: [
        "William 可以这样讲：today is about acceptance after a risk-off shock. Liquidity comes first, structure confirms second, and invalidation decides whether there is a trade.",
        "BTC 与 ETH 若扫低回收并形成 bullish CHOCH，再讲 discount retest；SOL 不同步或扫高后失守，就降低确定性。",
        "最近 key levels 从当前图表读取，刷新页面只更新报价、RSI、MACD、ATR 和实时口播行。"
      ],
      contextLines: [
        "The June 11 backdrop is a risk-off digestion session after inflation, yields, and renewed geopolitical stress pressured global assets.",
        "Crypto participation remains selective while gold has broken lower under rate pressure. Treat any bounce as a structure test, not automatic trend repair."
      ],
      marketTemplate: "刷新后如果 BTC/ETH 扫过 6月10日低点或当日 sell-side 后快速回收，并形成 displacement 与 CHOCH，主讲 FVG 或 order block 回踩；如果扫高失败、SOL 分化或 MACD 继续走弱，主讲反弹派发和等待。",
      assignment: "让成员提交 BTC 或 ETH 6月11日最新 4H 图，标出 6月10日高低点、当日 session 边界、sweep、BOS/CHOCH、entry zone、SL 和第一目标。"
    },
    "wed-market": {
      title: "ICT 当日行情跟进：6月11日区分 liquidity recovery 与弱反抽",
      summary: "William 用 ICT/SMC 跟进 2026-06-11：检查前一日风险回落后的修复是否形成 acceptance、structure shift 和可执行回踩。",
      hook: "William 今天只回答一个问题：前一日 sell-side 被拿走以后，市场有没有留下可以交易的 structure，还是只反抽到供应区？",
      outline: [
        "开场：说明当日跟进重点是 recovery quality，不用一根反弹 K 线代替结构确认。",
        "流动性：观察前一日低点下方 sell-side 与反弹高点上方 buy-side，确认哪一侧 sweep 后被接受。",
        "结构：higher low、displacement 和回踩守住才讲修复；回到 broken structure 下方就讲弱反抽。",
        "动能：刷新后用 BTC、ETH、SOL 的 RSI、MACD、ATR 检查同步性与剩余空间。",
        "风险：Gold 的破位和较高收益率说明宏观压力未解除，没有 invalidation 就不扩大仓位。"
      ],
      talk: [
        "William 可以这样讲：a liquidity recovery becomes tradable only when the structure shift survives the retest.",
        "BTC 与 ETH 同步修复、SOL 参与，才讲 bullish continuation；单币回抽或扫高回落，只算 market readout。",
        "RSI、MACD 和 ATR 负责验证动能与空间，entry 仍来自 liquidity、structure 和 invalidation。"
      ],
      contextLines: [
        "June 11 should separate a genuine liquidity recovery from a weak rebound after the prior risk-off session.",
        "Broad participation matters because speculative capital has been rotating away from crypto and Ether positioning remains defensive."
      ],
      marketTemplate: "刷新后如果 BTC/ETH 在前一日低点附近扫单回收、形成 higher low 且 SOL 同步，主讲 CHOCH 后回踩；如果扫高失败、ATR 收缩或跌回 broken structure，主讲弱反抽和二次派发。",
      assignment: "让成员提交 BTC 或 ETH 6月11日最新 4H 图，标出前一日区间、sweep、displacement、BOS/CHOCH、retest、SL 和第一目标。"
    },
    "fri-market": {
      title: "ICT 当日复盘转化：6月11日只记录 risk-off 后被确认的结构",
      summary: "William 用 2026-06-11 当日复盘筛选风险冲击后的有效结构，只保留 liquidity、acceptance、structure shift、retest 和 invalidation 完整的计划。",
      hook: "William 今天不复盘谁猜到底，只复盘 6月11日有没有把前一日风险冲击转成完整、可验证的 sequence。",
      outline: [
        "开场：复盘风险回落后的接受或拒绝，不把短线回抽外推成趋势。",
        "流动性：回看前一日高低点、当日 session 边界和近期清算区中最清楚的一次 sweep。",
        "结构：把 acceptance、BOS/CHOCH、FVG 或 order block 回踩和 invalidation 画完整。",
        "动能：刷新后用 BTC/ETH 的 RSI、MACD、ATR，并参考 SOL 是否同步验证结论。",
        "风险：Gold 和收益率背景仍偏防守；sequence 不完整就明确记录 no trade。"
      ],
      talk: [
        "William 可以这样讲：the lesson is whether the market earned acceptance after the risk-off move.",
        "只有 sweep、displacement、CHOCH 和 retest 都出现，才是 ICT setup；只有快速回抽或单币领先不是 entry。",
        "ATR 扩张时缩小仓位，ATR 收缩时缩小目标，没有 invalidation 就不执行。"
      ],
      contextLines: [
        "Use this as the June 11 same-day review of whether the market built durable structure after the global risk-off shock.",
        "Reward confirmed structure and cross-crypto participation, not bottom-picking or candle size."
      ],
      marketTemplate: "刷新后如果 BTC/ETH 已给出 sweep + acceptance + displacement + CHOCH + retest，主讲确认后的计划；如果扫高回落、SOL 不同步或动能衰减，主讲为什么没有 entry。",
      assignment: "让成员提交一张 6月11日复盘图，标出前一日区间、sweep、acceptance、BOS/CHOCH、回踩区、SL 和第一目标。"
    }
  },
  KC: {
    "mon-market": {
      title: "20 EMA 当日行情解读：6月11日先看 risk-off 后能否 reclaim",
      summary: "KC 用 20 EMA Blueprint 解读 2026-06-11：BTC、ETH、SOL 进入风险回落后的守线测试，Gold 破位提醒交易者先确认 EMA 位置和动能。",
      hook: "KC 今天不要因为价格止跌就直接做多。刷新行情后先回答：is price below the 20 EMA, reclaiming it, or holding the first pullback?",
      outline: [
        "开场：把 6月11日定义成 risk-off reclaim test，不追离均线太远的第一段反应。",
        "位置：标出主图 20 EMA、6月10日高低点、当日 session 边界和第一次回踩。",
        "确认：价格回到 EMA 正确一侧并得到实时 RSI、MACD 配合，才算 clean reclaim。",
        "目标：用实时 ATR 约束 TP；ETH/SOL 若不确认，主动缩小仓位和目标。",
        "风险：通胀、收益率和 Gold 破位仍是防守背景，Blueprint 没确认就继续等。"
      ],
      talk: [
        "KC 可以这样讲：after a risk-off move, the Blueprint starts with location. No EMA reclaim means no clean continuation setup.",
        "价格站回 20 EMA、RSI 守中线且 MACD 改善，才讲 first pullback；碰到 EMA 后再次被拒绝就等。",
        "具体报价由刷新后的页面数据和图表提供，静态稿件只定义位置、确认、止损和目标流程。"
      ],
      contextLines: [
        "The June 11 setup is an EMA reclaim test after inflation and geopolitical stress pushed global markets into a defensive session.",
        "Gold's sharp breakdown and weak crypto participation argue for confirmation first, smaller size, and ATR-based targets."
      ],
      marketTemplate: "刷新后如果主图守住或重新 reclaim 20 EMA，RSI/MACD 配合且第一次回踩稳定，主讲 clean recovery；如果失去 EMA、ETH/SOL 分化或 ATR 不支持目标，主讲 failed reclaim。",
      assignment: "让成员提交 BTC、Gold 或 SOL 6月11日最新图，标出 20 EMA、6月10日高低点、第一次回踩、entry、SL 和按实时 ATR 制定的目标。"
    },
    "wed-market": {
      title: "20 EMA 当日行情跟进：6月11日守线才算修复",
      summary: "KC 用 20 EMA Blueprint 跟进 2026-06-11：第一次回踩是否守线、RSI/MACD 是否确认、ATR 是否支持目标，决定风险回落后能否参与。",
      hook: "KC 今天的 quality check 很简单：did the reclaim survive the first pullback? 守不住 20 EMA，就没有 recovery setup。",
      outline: [
        "开场：把跟进定义成 first-pullback check，避免在风险回落后的第一段反抽追单。",
        "位置：检查主图是否贴近 20 EMA，以及回踩是否守在均线正确一侧。",
        "确认：刷新后用 RSI 中线和 MACD 柱体判断动能是真修复还是被动回抽。",
        "目标：用实时 ATR 制定第一目标；跨币分化或波动异常扩大时降低仓位。",
        "风险：Gold 失守中期位置时，不把 crypto 的局部稳定当作全市场风险偏好恢复。"
      ],
      talk: [
        "KC 可以这样讲：recovery means the EMA reclaim survives the first pullback.",
        "BTC 在 EMA 上方但 ETH 或 SOL 不确认，可以有 readout，但不一定有 full-size trade。",
        "价格碰到 EMA 后立即被拒绝，this is resistance, not a late long entry."
      ],
      contextLines: [
        "The June 11 follow-up should test whether stabilization can hold through a first pullback instead of becoming another weak rebound.",
        "Live 20 EMA location and cross-crypto participation carry more weight than any prior-session percentage move."
      ],
      marketTemplate: "刷新后如果主图在 20 EMA 上方完成第一次回踩、RSI 守中线且 MACD 改善，主讲 recovery continuation；如果跌回 EMA 下方、ATR 异常或跨币分化，主讲 fake reclaim 和等待。",
      assignment: "让成员提交 BTC、Gold 或 SOL 6月11日最新图，标出 20 EMA、第一次回踩、entry zone、SL 和实时 ATR 第一目标。"
    },
    "fri-market": {
      title: "20 EMA 当日复盘转化：6月11日让 ATR 过滤弱修复",
      summary: "KC 用 2026-06-11 当日复盘判断风险回落后的修复是否符合 Blueprint：20 EMA 定位置，RSI/MACD 定质量，ATR 定现实目标。",
      hook: "KC 今天复盘不要比较谁抓到底。Show me whether the EMA held, momentum confirmed, and the ATR justified the target。",
      outline: [
        "开场：复盘前一日风险冲击进入今天后有没有尊重 20 EMA。",
        "位置：标出主图、20 EMA、前一日高低点和第一次回踩的关系。",
      ...
      talk: [
        "KC 可以这样讲：a weak recovery fails when price cannot hold the EMA and momentum fades.",
        "reclaim 后守住第一次回踩，复盘 clean continuation；跌回 EMA 下方，复盘为什么没有 entry。",
        "Gold 破位、ETH/SOL 分化和 ATR 变化都要求先执行纪律，再讨论方向。"
      ],
      contextLines: [
        "Use this as a June 11 Blueprint recap after a defensive global session and a sharp gold selloff.",
        "Every conclusion should map to EMA location, momentum quality, ATR-based target, and a predefined stop."
      ],
      marketTemplate: "刷新后如果主图在 20 EMA 上方且 RSI 守中线，主讲 reclaim 后第一次回踩；如果价格低于 EMA、MACD 走弱、ATR 异常或 ETH/SOL 不确认，主讲短目标或观望。",
      assignment: "让成员提交一张 6月11日复盘图，标出 20 EMA、entry zone、SL、第一目标和实时 ATR 依据。"
    }
  },
  Caven: {
    "mon-market": {
      title: "Scalp 当日行情解读：6月11日只做 risk-off 后的边界反应",
      summary: "Caven 用 liquidity、VWAP 和 ATR 解读 2026-06-11：BTC/SOL 正在消化风险冲击，只交易前一日或 session 边界 sweep 后的 VWAP 回收或拒绝。",
      hook: "Caven 今天不要在前一日大波动后追中间。先刷新行情，把 SOL/BTC 的 6月10日 high/low、当日 session 边界、近期清算区和 VWAP 画出来。",
      outline: [
        "开场：说明 6月11日是 risk-off digestion，重点是边界反应，不是方向口号。",
        "流动性：标出 SOL/BTC 前一日高低点、当日 session high/low 和近期清算区。",
        "VWAP：扫低并回收 VWAP 才讲 long scalp；扫高后跌回 VWAP 下方才讲 short scalp。",
        "波动：刷新后读取 RSI、MACD、ATR，并用 ETH 是否同步检查参与度。",
        "风险：宏观波动仍高，区间中间、低 ATR 或失控扩张环境都不追单。"
      ],
      talk: [
        "Caven 可以这样讲：yesterday's volatility is not today's entry. We trade the reaction at the session edge.",
        "SOL 扫 session low、收回前一日边界并站上 VWAP，而且 BTC 同步，才有 quick long scalp；扫高失去 VWAP 就讲 trap breakout。",
        "静态稿件不写死价格，最近 key levels 都来自刷新后的图表与当日 session。"
      ],
      contextLines: [
        "The June 11 scalp backdrop is a digestion session after a global risk-off move. Crypto remains selective, so execution belongs at prior-day and session edges.",
        "Gold's rate-driven breakdown is macro caution only; crypto scalp triggers still come from liquidity, VWAP, participation, and ATR."
      ],
      marketTemplate: "刷新后如果 SOL/BTC 扫低、收回前一日或 session 边界并站上 VWAP，且实时 ATR 足够，主讲 quick long scalp；如果扫高失败、低于 VWAP 或卡在中间，主讲 short scalp 或等待。",
      assignment: "让成员提交 SOL 或 BTC 6月11日 15M 图，标出 6月10日 high/low、session 边界、一次 sweep、VWAP、entry、SL 和第一止盈。"
    },
    "wed-market": {
      title: "Scalp 当日行情跟进：6月11日检查 VWAP recovery",
      summary: "Caven 用 liquidity、VWAP 和短线波动跟进 2026-06-11：只看风险回落后边界被扫的回收或拒绝，并用 ATR 判断是否还有 scalp 空间。",
      hook: "Caven 今天跟进先问三个问题：边界 sweep 了吗，VWAP 守住了吗，ATR 还可控吗？少一个就等。",
      outline: [
        "开场：把跟进定义成 session recovery check，不追已经发生的第一段反抽。",
        "流动性：确认 SOL/BTC 哪一侧前一日或 session liquidity 已被扫，哪一侧仍是下一目标。",
        "VWAP：扫低后回收并守住才讲 continuation；扫高后跌回下方就讲 trap breakout。",
        "波动：刷新后用 RSI、MACD、ATR 检查动能、空间与跨币同步。",
        "执行：区间中间、ATR 失控、VWAP 反复穿越都不是 clean scalp。"
      ],
      talk: [
        "Caven 可以这样讲：the reaction at the edge matters more than the first rebound.",
        "SOL 扫低后站回 VWAP、RSI 修复且 BTC 同步，可以讲 quick long scalp。",
        "价格回到 VWAP 又马上失守，shorten the target or skip the trade."
      ],
      contextLines: [
        "The June 11 follow-up focuses on whether price can hold VWAP after liquidity is taken at a prior-day or session edge.",
        "Live ATR and cross-crypto participation decide whether the move has enough controlled range for a scalp."
      ],
      marketTemplate: "刷新后如果 SOL/BTC 在边界 sweep 后守住 VWAP、且 ATR 仍支持空间，主讲 recovery scalp；如果价格低于 VWAP、ATR 失控或 RSI 没修复，主讲 failed retest 和等待。",
      assignment: "让成员提交 SOL 或 BTC 6月11日 15M 图，标出前一日 high/low、session 边界、sweep、VWAP 回收或拒绝、entry、SL 和第一止盈。"
    },
    "fri-market": {
      title: "Scalp 当日复盘转化：6月11日只复盘 edge、sweep、VWAP",
      summary: "Caven 用 2026-06-11 当日复盘把前一日边界、session sweep、VWAP、RSI 和 ATR 转成短线作业，中间位置不点评。",
      hook: "Caven 今天不复盘谁抓到底，只复盘有没有 edge、sweep、VWAP reaction 和可控 ATR。",
      outline: [
        "开场：复盘 risk-off 后最清楚的一次扫高或扫低，不用固定价格总结。",
        "流动性：标出 SOL/BTC 前一日高低点、当日 session 边界和被扫的一侧。",
        "VWAP：确认 sweep 后是回收、拒绝，还是一直在中间震荡。",
        "波动：刷新后用 RSI、MACD、ATR 判断这笔 scalp 是否有足够且可控的空间。",
        "转化：止损必须放在 sweep 外侧，VWAP 失效就快速退出。"
      ],
      talk: [
        "Caven 可以这样讲：the clean trade is the reaction after liquidity is taken and VWAP confirms.",
        "SOL 或 BTC 扫 session low 后站回 VWAP，并且 RSI 修复，复盘 clean long scalp；扫高后跌回 VWAP 下方就复盘 trap breakout。",
        "ATR 收缩时目标变小，ATR 失控时仓位变小，宏观风险仍高时不留高杠杆方向仓位。"
      ],
      contextLines: [
        "Use this as the June 11 same-day scalp review after a high-volatility global risk-off session.",
        "Every recap should map to boundary, sweep, VWAP reaction, momentum, ATR space, and fast invalidation."
      ],
      marketTemplate: "刷新后如果 SOL/BTC 的 ATR 仍支持可控空间且 RSI 修复，主讲扫低回收 VWAP；如果 ATR 失控、价格低于 VWAP 或卡在 session 中间，主讲缩小仓位、扫高失败或等待。",
      assignment: "让成员提交一张 6月11日 15M 复盘图，标出前一日 high/low、session 边界、一次有效 sweep、VWAP、entry、SL 和第一止盈。"
    }
  }
};

const JUNE_9_MARKET_READOUT_OVERRIDES = {
  William: {
    "mon-market": {
      title: "ICT 当日行情解读：6月9日检验 relief bounce 的接受度",
      summary: "William 用 ICT/SMC 解读 2026-06-09 当日市场：BTC、ETH、SOL 正在检验前一日反弹能否转成结构修复，Gold 的利率压力仍提醒市场控制风险。",
      hook: "William 今天不要因为昨天反弹就预设延续。先刷新行情，标出 6月8日 relief high、前一日高低点、近期清算低点和亚洲盘边界，再看 sweep 后有没有 acceptance。",
      outline: [
        "开场：把 6月9日定义成 relief bounce follow-through test，周线结构仍受损，先检查接受度。",
        "流动性：标出 6月8日反弹高点、前一日高低点、近期清算低点和当日 session 边界。",
        "结构：站稳前一日反弹区并给出 displacement、BOS/CHOCH 才算修复；扫高后跌回区间则按派发处理。",
        "动能：刷新后比较 BTC/ETH 的 RSI、MACD、ATR，并用 SOL 是否同步确认风险偏好广度。",
        "风险：ETF 流出和偏鹰利率预期仍是背景；Gold 承压时，不把单日 crypto 反弹讲成趋势反转。"
      ],
      talk: [
        "William 可以这样讲：today is an acceptance test after a relief bounce. ICT needs liquidity, displacement, structure shift, and a clear invalidation.",
        "BTC 与 ETH 若守住前一日区间并在扫低后形成 bullish CHOCH，才讲 discount retest；如果 SOL 不同步，就把确定性降下来。",
        "所有 key levels 都从当前图表读取，页面刷新只更新实时价格和指标，不改变这套结构框架。"
      ],
      contextLines: [
        "The June 9 backdrop is a follow-through test after a broad but short-squeeze-heavy crypto rebound. Weekly damage and fund outflows mean acceptance matters more than the size of the bounce.",
        "Gold remains under pressure from stronger jobs data, higher yields, and firmer rate expectations. Use that as macro risk context, not as a fixed crypto signal."
      ],
      marketTemplate: "刷新后如果 BTC/ETH 守住前一日区间、扫低回收并形成 CHOCH，主讲 FVG 或 order block 回踩；如果扫过 6月8日高点后跌回、SOL 分化或 MACD 走弱，主讲 buy-side liquidity grab 和等待。",
      assignment: "让成员提交 BTC 或 ETH 6月9日最新 4H 图，标出 6月8日高低点、当日 session 边界、sweep、BOS/CHOCH、entry zone、SL 和第一目标。"
    },
    "wed-market": {
      title: "ICT 当日行情跟进：6月9日区分 retest 和二次派发",
      summary: "William 用 ICT/SMC 跟进 2026-06-09：检查前一日反弹区的回踩是形成 higher low，还是扫高后回到 broken structure 下方。",
      hook: "William 今天只回答一个问题：昨天的 rebound 有没有在今天的 retest 里留下 tradable structure？没有守住结构，就只是一段 short covering。",
      outline: [
        "开场：说明当日重点是 retest quality，不用上涨幅度替代结构确认。",
        "流动性：观察前一日高点上方 buy-side 与近期清算低点下方 sell-side，确认 sweep 后哪一侧被接受。",
        "结构：higher low、displacement 和回踩守住才讲延续；跌回 broken structure 就讲二次派发。",
        "动能：刷新后用 BTC、ETH、SOL 的 RSI、MACD、ATR 检查同步性与剩余空间。",
        "风险：宏观利率压力和 ETF 流出仍在，没有清楚 invalidation 就不扩大仓位。"
      ],
      talk: [
        "William 可以这样讲：a rebound becomes tradable only when the retest holds and structure confirms.",
        "BTC 与 ETH 同步守住结构、SOL 参与，才讲 bullish continuation；单币上冲或扫高回落，就降低预期。",
        "RSI、MACD 和 ATR 负责确认与空间，entry 仍来自 liquidity、structure 和 invalidation。"
      ],
      contextLines: [
        "June 9 should separate a healthy retest from a second distribution leg after the oversold rebound.",
        "Cross-crypto participation is important because the prior move was helped by short covering while the broader weekly trend remained weak."
      ],
      marketTemplate: "刷新后如果 BTC/ETH 在前一日反弹区形成 higher low、RSI/MACD 改善且 SOL 同步，主讲 BOS 后回踩；如果扫高失败、ATR 收缩或跌回 broken structure，主讲二次派发。",
      assignment: "让成员提交 BTC 或 ETH 6月9日最新 4H 图，标出前一日区间、sweep、displacement、BOS/CHOCH、retest、SL 和第一目标。"
    },
    "fri-market": {
      title: "ICT 当日复盘转化：6月9日只记录被确认的 follow-through",
      summary: "William 用 2026-06-09 当日复盘筛选 relief bounce 后的有效结构，只保留 liquidity、acceptance、structure shift、retest 和 invalidation 完整的计划。",
      hook: "William 今天不复盘谁追到反弹，只复盘 6月9日有没有把前一日 move 转成完整 sequence。",
      outline: [
        "开场：复盘 relief bounce 后的接受或拒绝，不把短 squeeze 外推成趋势。",
        "流动性：回看前一日高低点、当日 session 边界和近期清算低点中最清楚的一次 sweep。",
        "结构：把 acceptance、BOS/CHOCH、FVG 或 order block 回踩和 invalidation 画完整。",
        "动能：刷新后用 BTC/ETH 的 RSI、MACD、ATR，并参考 SOL 是否同步验证结论。",
        "风险：Gold 与利率背景仍偏防守；sequence 不完整就明确记录 no trade。"
      ],
      talk: [
        "William 可以这样讲：the lesson is whether the relief bounce earned acceptance on the retest.",
        "只有 sweep、displacement、CHOCH 和 retest 都出现，才是 ICT setup；只有快速上涨或单币领先只是 readout。",
        "周线仍弱时缩小仓位，ATR 收缩时缩小目标，没有 invalidation 就不执行。"
      ],
      contextLines: [
        "Use this as the June 9 same-day review of whether the oversold rebound produced durable structure or failed at the first retest.",
        "Reward confirmed structure and broad participation, not candle size or bottom-picking."
      ],
      marketTemplate: "刷新后如果 BTC/ETH 已给出 sweep + acceptance + displacement + CHOCH + retest，主讲确认后的计划；如果扫高回落、SOL 不同步或动能衰减，主讲为什么没有 entry。",
      assignment: "让成员提交一张 6月9日复盘图，标出前一日区间、sweep、acceptance、BOS/CHOCH、回踩区、SL 和第一目标。"
    }
  },
  KC: {
    "mon-market": {
      title: "20 EMA 当日行情解读：6月9日检验 rebound reclaim",
      summary: "KC 用 20 EMA Blueprint 解读 2026-06-09：BTC、ETH、SOL 的前一日反弹进入守线测试，Gold 仍受收益率和偏鹰利率预期压制。",
      hook: "KC 今天不要追昨天的 bounce。刷新行情后先回答：is price holding above the 20 EMA, retesting it, or losing the reclaim?",
      outline: [
        "开场：把 6月9日定义成 reclaim follow-through test，周线仍弱，不追离均线太远的位置。",
        "位置：标出主图 20 EMA、6月8日高低点、当日 session 边界和第一次回踩。",
        "确认：价格守在 EMA 正确一侧并得到实时 RSI、MACD 配合，才算 clean reclaim。",
        "目标：用实时 ATR 约束 TP；ETH/SOL 若不确认，主动缩小仓位和目标。",
        "风险：ETF 流出与偏鹰利率背景仍在，Gold 承压时更要按 Blueprint 执行。"
      ],
      talk: [
        "KC 可以这样讲：the bounce was yesterday. Today the Blueprint asks whether the reclaim can survive the first retest.",
        "价格守住 20 EMA、RSI 守中线且 MACD 改善，才讲 first pullback；重新跌到 EMA 下方就等。",
        "具体报价由刷新后的页面数据和图表提供，静态稿件只定义位置、确认、止损和目标流程。"
      ],
      contextLines: [
        "The June 9 setup is a reclaim quality test after a broad oversold rebound. Weekly losses and short-covering activity mean one strong session is not enough.",
        "Gold remains a caution chart as stronger jobs data and higher yields weigh on non-yielding assets."
      ],
      marketTemplate: "刷新后如果主图守住或重新 reclaim 20 EMA，RSI/MACD 配合且第一次回踩稳定，主讲 clean continuation；如果失去 EMA、ETH/SOL 分化或 ATR 不支持目标，主讲 failed reclaim。",
      assignment: "让成员提交 BTC、Gold 或 SOL 6月9日最新图，标出 20 EMA、6月8日高低点、第一次回踩、entry、SL 和按实时 ATR 制定的目标。"
    },
    "wed-market": {
      title: "20 EMA 当日行情跟进：6月9日守线才算 follow-through",
      summary: "KC 用 20 EMA Blueprint 跟进 2026-06-09：第一次回踩是否守线、RSI/MACD 是否确认、ATR 是否支持目标，决定反弹能否继续。",
      hook: "KC 今天的 quality check 不变：did price hold the 20 EMA after the rebound? 守不住，就没有 continuation setup。",
      outline: [
        "开场：把跟进定义成 first-pullback check，避免在 relief bounce 尾端追单。",
        "位置：检查主图是否贴近 20 EMA，以及回踩是否守在均线正确一侧。",
        "确认：刷新后用 RSI 中线和 MACD 柱体判断动能是真修复还是短 squeeze。",
        "目标：用实时 ATR 制定第一目标；跨币分化或波动收缩时降低预期。",
        "风险：Gold 和利率背景偏弱时，不把 crypto 反弹当作全市场风险偏好恢复。"
      ],
      talk: [
        "KC 可以这样讲：follow-through means the reclaim survives the first pullback.",
        "BTC 在 EMA 上方但 ETH 或 SOL 不确认，可以有 readout，但不一定有 full-size trade。",
        "价格碰到 EMA 后立即被拒绝，this is resistance, not a late long entry."
      ],
      contextLines: [
        "The June 9 follow-up should test whether the rebound can hold through a first pullback instead of becoming a shallow bounce.",
        "Live 20 EMA location and cross-crypto participation carry more weight than the prior session's percentage gain."
      ],
      marketTemplate: "刷新后如果主图在 20 EMA 上方完成第一次回踩、RSI 守中线且 MACD 改善，主讲 continuation；如果跌回 EMA 下方、ATR 收缩或跨币分化，主讲 fake reclaim 和等待。",
      assignment: "让成员提交 BTC、Gold 或 SOL 6月9日最新图，标出 20 EMA、第一次回踩、entry zone、SL 和实时 ATR 第一目标。"
    },
    "fri-market": {
      title: "20 EMA 当日复盘转化：6月9日让 ATR 过滤浅反弹",
      summary: "KC 用 2026-06-09 当日复盘判断前一日反弹是否守住 Blueprint：20 EMA 定位置，RSI/MACD 定质量，ATR 定现实目标。",
      hook: "KC 今天复盘不要比较谁抓到 bounce。Show me whether the EMA held, momentum confirmed, and the ATR justified the target。",
      outline: [
        "开场：复盘前一日反弹进入今天后有没有尊重 20 EMA。",
        "位置：标出主图、20 EMA、前一日高低点和第一次回踩的关系。",
        "确认：刷新后用 RSI、MACD 判断修复、拒绝还是低动能震荡。",
      ...
      talk: [
        "KC 可以这样讲：a shallow bounce fails when price cannot hold the EMA and momentum fades.",
        "reclaim 后守住第一次回踩，复盘 clean continuation；跌回 EMA 下方，复盘为什么没有 entry。",
        "Gold 偏弱、ETH/SOL 分化和 ATR 变化都要求先执行纪律，再讨论方向。"
      ],
      contextLines: [
        "Use this as a June 9 Blueprint recap after an oversold rebound in a still-damaged weekly market.",
        "Every conclusion should map to EMA location, momentum quality, ATR-based target, and a predefined stop."
      ],
      marketTemplate: "刷新后如果主图在 20 EMA 上方且 RSI 守中线，主讲 reclaim 后第一次回踩；如果价格低于 EMA、MACD 走弱、ATR 收缩或 ETH/SOL 不确认，主讲短目标或观望。",
      assignment: "让成员提交一张 6月9日复盘图，标出 20 EMA、entry zone、SL、第一目标和实时 ATR 依据。"
    }
  },
  Caven: {
    "mon-market": {
      title: "Scalp 当日行情解读：6月9日只做 rebound 边界反应",
      summary: "Caven 用 liquidity、VWAP 和 ATR 解读 2026-06-09：BTC/SOL 的前一日反弹进入 session retest，只交易边界 sweep 后的 VWAP 回收或拒绝。",
      hook: "Caven 今天不要追昨天的 squeeze。先刷新行情，把 SOL/BTC 的 6月8日 high/low、当日 session 边界、近期清算低点和 VWAP 画出来。",
      outline: [
        "开场：说明 6月9日是 relief-bounce retest，重点是边界反应，不是方向口号。",
        "流动性：标出 SOL/BTC 前一日高低点、当日 session high/low 和近期清算低点。",
        "VWAP：扫低并回收 VWAP 才讲 long scalp；扫高后跌回 VWAP 下方才讲 short scalp。",
        "波动：刷新后读取 RSI、MACD、ATR，并用 ETH 是否同步检查参与度。",
        "风险：周线仍弱、短 squeeze 成分高，区间中间和低 ATR 环境都不交易。"
      ],
      talk: [
        "Caven 可以这样讲：yesterday's squeeze is not today's entry. We trade the session boundary reaction.",
        "SOL 扫 session low、收回前一日边界并站上 VWAP，而且 BTC 同步，才有 quick long scalp；扫高失去 VWAP 就讲 trap breakout。",
        "静态稿件不写死价格，最近 key levels 都来自刷新后的图表与当日 session。"
      ],
      contextLines: [
        "The June 9 scalp backdrop is a retest after a short-squeeze-heavy crypto rebound. Weekly losses remain deep, so execution belongs at session edges.",
        "Gold's rate-driven weakness is macro caution only; crypto scalp triggers still come from liquidity, VWAP, participation, and ATR."
      ],
      marketTemplate: "刷新后如果 SOL/BTC 扫低、收回前一日或 session 边界并站上 VWAP，且实时 ATR 足够，主讲 quick long scalp；如果扫高失败、低于 VWAP 或卡在中间，主讲 short scalp 或等待。",
      assignment: "让成员提交 SOL 或 BTC 6月9日 15M 图，标出 6月8日 high/low、session 边界、一次 sweep、VWAP、entry、SL 和第一止盈。"
    },
    "wed-market": {
      title: "Scalp 当日行情跟进：6月9日检查 VWAP retest",
      summary: "Caven 用 liquidity、VWAP 和短线波动跟进 2026-06-09：只看前一日边界被扫后的回收或拒绝，并用 ATR 判断是否还有 scalp 空间。",
      hook: "Caven 今天跟进先问三个问题：边界 sweep 了吗，VWAP 守住了吗，ATR 还够吗？少一个就等。",
      outline: [
        "开场：把跟进定义成 session retest check，不追已经发生的反弹。",
        "流动性：确认 SOL/BTC 哪一侧前一日或 session liquidity 已被扫，哪一侧仍是下一目标。",
        "VWAP：扫低后回收并守住才讲 continuation；扫高后跌回下方就讲 trap breakout。",
        "波动：刷新后用 RSI、MACD、ATR 检查动能、空间与跨币同步。",
      ...
      talk: [
        "Caven 可以这样讲：the retest matters more than the first bounce.",
        "SOL 扫低后站回 VWAP、RSI 修复且 BTC 同步，可以讲 quick long scalp。",
        "价格回到 VWAP 又马上失守，shorten the target or skip the trade."
      ],
      contextLines: [
        "The June 9 follow-up focuses on whether the rebound can hold VWAP after liquidity is taken at a prior-day or session edge.",
        "Live ATR and cross-crypto participation decide whether the move has enough range for a scalp."
      ],
      marketTemplate: "刷新后如果 SOL/BTC 在边界 sweep 后守住 VWAP、且 ATR 仍支持空间，主讲 continuation scalp；如果价格低于 VWAP、ATR 收缩或 RSI 没修复，主讲 failed retest 和等待。",
      assignment: "让成员提交 SOL 或 BTC 6月9日 15M 图，标出前一日 high/low、session 边界、sweep、VWAP 回收或拒绝、entry、SL 和第一止盈。"
    },
    "fri-market": {
      title: "Scalp 当日复盘转化：6月9日只复盘 edge、sweep、VWAP",
      summary: "Caven 用 2026-06-09 当日复盘把前一日边界、session sweep、VWAP、RSI 和 ATR 转成短线作业，中间位置不点评。",
      hook: "Caven 今天不复盘谁追到 rebound，只复盘有没有 edge、sweep、VWAP reaction 和足够 ATR。",
      outline: [
        "开场：复盘 relief bounce 后最清楚的一次扫高或扫低，不用固定价格总结。",
        "流动性：标出 SOL/BTC 前一日高低点、当日 session 边界和被扫的一侧。",
        "VWAP：确认 sweep 后是回收、拒绝，还是一直在中间震荡。",
        "波动：刷新后用 RSI、MACD、ATR 判断这笔 scalp 是否有足够空间。",
        "转化：止损必须放在 sweep 外侧，VWAP 失效就快速退出。"
      ],
      talk: [
        "Caven 可以这样讲：the clean trade is the reaction after liquidity is taken and VWAP confirms.",
        "SOL 或 BTC 扫 session low 后站回 VWAP，并且 RSI 修复，复盘 clean long scalp；扫高后跌回 VWAP 下方就复盘 trap breakout。",
        "ATR 收缩时目标变小，周线结构仍弱时不留高杠杆方向仓位。"
      ],
      contextLines: [
        "Use this as the June 9 same-day scalp review of whether the prior rebound survived a session-edge retest.",
        "Every recap should map to boundary, sweep, VWAP reaction, momentum, ATR space, and fast invalidation."
      ],
      marketTemplate: "刷新后如果 SOL/BTC 的 ATR 仍支持空间且 RSI 修复，主讲扫低回收 VWAP；如果 ATR 收缩、价格低于 VWAP 或卡在 session 中间，主讲缩短目标、扫高失败或等待。",
      assignment: "让成员提交一张 6月9日 15M 复盘图，标出前一日 high/low、session 边界、一次有效 sweep、VWAP、entry、SL 和第一止盈。"
    }
  }
};

const JUNE_8_MARKET_READOUT_OVERRIDES = {
  William: {
    "mon-market": {
