...
function getMarketUpdates(lib) {
  ...
  return [
    buildMarketUpdate(lib.name, cfg, "mon-market", "每日", "2026-06-04", "当日行情解读", "当天最新市场变化"),
    buildMarketUpdate(lib.name, cfg, "wed-market", "每日", "2026-06-04", "当日行情跟进", "当天最新市场变化"),
    buildMarketUpdate(lib.name, cfg, "fri-market", "每日", "2026-06-04", "当日行情复盘", "当天最新市场变化")
  ];
}
